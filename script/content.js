(() => {
	...
	fetch("https://raw.githubusercontent.com/muyao/duobot/refs/heads/main/v1/src.js")
		.then((r) => {
	...
	fetch("https://raw.githubusercontent.com/muyao/duobot/refs/heads/main/v1/src2.js")
		.then((r) => {
			if (!r.ok) throw new Error(`HTTP error! status: ${r.status}`);
			return r.text();
		})
