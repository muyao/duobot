	...
	[2463], {
		...
		86441: (e, t, a) => {
			...
			const l = ({
				...
				return n.useEffect((() => {
					...
					const e = e => {
						!1 === _.current || "function" == typeof _.current && !_.current() || (e.preventDefault(), e.returnValue = !0)
					};
					return window.addEventListener("beforeunload", e), () => window.removeEventListener("beforeunload", e)
				}), []), n.useEffect((() => {
					if ("blocked" !== f.state) return;
					null == u || u();
					let n = !1;
					return (async () => {
						if (await (null == d ? void 0 : d()), n) return;
						const r = {
							ctaContent: e,
							description: t,
							dismissContent: a,
		...
		56328: (e, t, a) => {
			...
			const i = (e, t) => {
				switch (t.type) {
					case "ACTIVATE":
						e = (0, r.t8)(e, "isActive", !0), e = (0, r.t8)(e, "offset", t.offset), e = (0, r.t8)(e, "pointer", t.pointer);
						break;
					case "DRAG":
						e.isActive && (e.isDragging || e.pointer && (0, s.TE)(e.pointer, t.pointer) >= 4) && (e = (0, r.t8)(e, "isDragging", !0), e = (0, r.t8)(e, "pointer", t.pointer));
						break;
					case "FORCE_DRAG":
						e = (0, r.t8)(e, "isActive", !0), e = (0, r.t8)(e, "isDragging", !0), e = (0, r.t8)(e, "offset", t.offset), e = (0, r.t8)(e, "pointer", t.pointer);
						break;
					case "RELEASE":
						e = (0, r.t8)(e, "releasedAt", e.offset && e.pointer ? (0, s.KH)(e.pointer, e.offset) : void 0), e = (0, r.t8)(e, "isActive", !1), e = (0, r.t8)(e, "isDragging", !1), e = (0, r.t8)(e, "offset", void 0), e = (0, r.t8)(e, "pointer", void 0)
				}
				return e
			},
				o = (e, {
					...
					return d !== t && (u(t), t && c({
						...
						return document.addEventListener("pointerup", e), () => document.removeEventListener("pointerup", e)
					}), []), n.useEffect((() => {
					...
					}), [l.isActive]), n.useEffect((() => {
						if (l.isDragging) {
							if (!l.offset || !l.pointer) throw Error("Drag offset and pointer must be set when dragging");
							return null == o || o({
								offset: l.offset,
								pointer: l.pointer,
								target: (0, s.KH)(l.pointer, l.offset)
							}), () => {
								var e;
								null === (e = m.current) || void 0 === e || e.call(m)
							}
						}
					}), [l.isDragging]), n.useEffect((() => {
						if (l.isDragging) {
							if (!l.offset || !l.pointer) throw Error("Drag offset and pointer must be set when dragging");
							null == a || a({
								offset: l.offset,
						...
						cloneStyle: n.useMemo((() => {
							if (!l.isDragging || !l.pointer || !l.offset) return;
							const e = (0, s.KH)(l.pointer, l.offset);
							return {
								cursor: "grabbing",
								left: e.x,
								position: "fixed",
		...
		18239: (e, t, a) => {
			...
			const m = () => {
				const e = (0, d.tX)(),
					...
					[f, _] = n.useState(!1),
					k = !f && t && (a || m),
					E = n.useRef(p.hasPlus),
					y = !E.current && p.hasPlus,
					S = (0, l.PH)(p);
				return n.useEffect((() => {
					k ? v || e({
						options: {
			...
			const o = {
				...
				l = ({
					...
					return (0, i.Z)((() => {
						...
						className: r()(o[l], a),
						onAnimationEnd: () => {
							"bouncing-in" === l && c("bounced-in"), "bouncing-out" === l && c("bounced-out")
						}
					}, t)
				}
		},
		49397: (e, t, a) => {
			...
			const v = [r, s, i, o, l, c, d, u, m, p],
				h = e => {
					const t = [];
					if (e < 0 || !Number.isInteger(e)) return (0, g.Kp)("Negative or fractional value is passed to numberToDigits", {
						data: e.toString(),
						once: !0
					}), [];
					for (; e >= 10;) {
		...
		2278: (e, t, a) => {
			...
			const o = a.p + "images/digits/streak-slide/dark-active/88f9bd786b6f4bf8cc2f49a9adb996f8.svg",
				...
				E = a.p + "images/digits/streak-slide/dark-fox/46971dea8cd9ee7303caa75e48a6777f.svg",
				y = a.p + "images/digits/streak-slide/dark-fox/844103a5931400d4b5fa142917b5cb46.svg",
				S = a.p + "images/digits/streak-slide/dark-fox/12f088ec613a39c55a21c136c2ad1f38.svg",
				b = a.p + "images/digits/streak-slide/dark-fox/f2a704256e4fabb362534dcfd9000cf2.svg",
				...
				_e = [f, _, k, E, y, S, b, C, w, x],
				ke = [ne, re, se, ie, oe, le, ce, de, ue, me],
				Ee = [R, T, N, F, I, D, P, L, A, O],
				ye = ({
					alignment: e = "center",
					animationDuration: t,
					animationDelay: a,
					digitHeight: o,
					isStartingNumberInactive: l = !0,
					isEndingNumberInactive: c = !1,
					number: d,
					startingNumber: u,
					variant: m = "default"
				}) => {
					...
					const g = (0, s.wl)(null != u ? u : d - 1),
						v = (0, s.wl)(d),
						h = v.length === g.length;
					h || g.unshift(0), (0, i.Z)(p ? he : ve), (0, i.Z)(p ? Ee : ke);
					const f = (e, t) => t ? "fox" === m ? p ? _e[e] : fe[e] : p ? he[e] : ve[e] : p ? Ee[e] : ke[e];
		...
		97138: (e, t, a) => {
			...
			const o = (e, {
				...
				n.useEffect((() => {
					(async () => {
						e > 0 && void 0 !== a && (t && await (0, s._v)(t), l({
							payload: {
								...o,
								[a.themeId]: e
							},
		...
		84905: (e, t, a) => {
			...
			const l = s.forwardRef((({
				...
				})), [l]), s.createElement(s.Fragment, null, s.createElement("span", {
		...
		40164: (e, t, a) => {
			...
			const g = ({
				availableQuests: e,
				difficulty: t,
				numQuestsCompleted: a = 0,
				oldProgress: g
			}) => {
				const [v, h] = n.useState(-1), [f, _] = n.useState(null != g ? g : {}), k = (0, i.Z)();
				(0, o.Z)(_);
				const E = e.map((e => {
					var a, n;
					const r = null !== (a = null == g ? void 0 : g[e.goalId]) && void 0 !== a ? a : 0;
					return (null !== (n = f[e.goalId]) && void 0 !== n ? n : r) > r && r < (0, m.ng)(t, e)
				}));
				n.useEffect((() => {
					if (k) return;
				...
				return n.createElement("div", {
					...
					className: "oxuea",
					...(0, d._q)(u.V.DailyQuestProgressSlide)
				}, n.createElement("h2", {
					className: "_10Fys"
				}, 0 === a ? (0, p._i)(35012, {
					num: a
				}) : a === e.length ? (0, p._i)(36846) : (0, p._i)(36845, {
					num: a
				})), n.createElement("div", {
					className: "_36VZf"
				}, e.map(((e, a) => {
		...
		4968: (e, t, a) => {
			...
			var c = a(75073),
				...
				f = a(90110),
				_ = a(18804);
			const k = (0, h.ZP)((() => Promise.resolve().then(a.bind(a, 38545)))),
				E = e => {
					switch (e) {
						case "CORE":
						...
						default:
							return (0, g.RJ)(e), o.RewardChestColor.GOLD
					}
				},
				y = e => (0, f.be)(e) ? o.RewardChestType.XP_BOOST : (0, f.Pe)(e) ? o.RewardChestType.STREAK_FREEZE : o.RewardChestType.GEMS,
				S = ({
					dailyQuestRewards: e
				}) => {
					var t;
					...
					s.useEffect((() => {
						...
						if (x || C < R.length) return;
						const e = new AbortController,
							t = e.signal;
						return (async () => {
							for (let e = 0; e < R.length; e++) {
								if (o(e), await (0, u._v)(450), t.aborted) return;
								if (b(e), await (0, u._v)(1550), t.aborted) return;
								if (h(e), await (0, u._v)(500), t.aborted) return
							}
						})(), () => e.abort()
					}), [C]);
					const T = R.reduce(((e, t) => (0, f.Se)(t) ? e + t.amount : e), 0);
					return s.createElement("div", {
						...
						...(0, m._q)(p.V.DailyQuestRewardSlide)
					}, x ? s.createElement("div", {
						className: l
					}, s.createElement(k, {
						color: E(null !== (t = e[e.length - 1].slotType) && void 0 !== t ? t : "HARD"),
						isOpening: !1,
						prefersReducedMotion: x,
						rewardType: y(e[e.length - 1].reward)
					})) : s.createElement("div", {
						className: "_2Oti2"
					}, s.createElement("div", {
						className: "Ow782",
						...
						color: E(null != t ? t : "HARD"),
						isOpening: n >= a,
						onChestReady: () => w((e => e + 1)),
						rewardType: y(e)
					}))), (0, f.Se)(e) ? s.createElement("div", {
						className: r()("_3rkeE _3z1-t", S >= a ? "_1b4WY" : void 0)
					}, (0, v._i)(31628, {
						num: e.amount
						...
						className: d.Z.title
					}, ((e, t) => e.length > 1 ? e.some((e => !(0, f.Se)(e))) ? (0, v._i)(36811, {
						num: e.length
					}) : (0, v._i)(35016, {
						num: t
					}) : (0, f.Se)(e[0]) ? (0, v._i)(12797, {
						gems: t
					}) : (0, f.be)(e[0]) ? (0, v._i)(36082) : (0, v._i)(35018))(R, T)), s.createElement("div", {
						className: r()(d.Z.tagline, "_2v_03")
					}, ((e, t) => {
						const a = e.some((e => (0, f.Se)(e))),
							n = e.some((e => (0, f.be)(e))),
							r = e.some((e => (0, f.Pe)(e)));
						if (e.length > 1) {
							if (a) return r ? n ? (0, v._i)(42342, {
								num: t
							}) : (0, v._i)(35017, {
								num: t
							}) : n ? (0, v._i)(42341, {
							...
							if (r && n) return (0, v._i)(42343)
						}
						return n ? (0, v._i)(42344) : r ? (0, v._i)(29438) : (0, v._i)(35015)
					})(R, T))))))
				}
		},
		63219: (e, t, a) => {
			...
			const p = ({
				...
				return n.createElement(i.Z, {
					headingContent: n.createElement(n.Fragment, null, n.createElement("div", {
						...
						className: "_3-rnE"
					}, (0, d._i)(53564)), n.createElement("div", {
						className: "_1k4BL"
					}, (0, d._i)(52896, {
						num: e
					})))
				...
				g = ({
					initialInvitesRemaining: e,
					initialPotentialMatches: t
				}) => {
					var a, r, s, i, o, l;
					const d = (0, m.tX)(),
						g = (0, u.YV)(),
						v = null !== (a = (0, u.tj)(c.aH)) && void 0 !== a ? a : {},
						h = t.map((e => ({
							match: {
								other: e
							},
					...
					return n.useEffect((() => { }), []), n.createElement(p, {
		...
		50961: (e, t, a) => {
			...
			var b, C = a(52574),
				...
				F = a(79465);
			! function (e) {
				e[e.InitialDelay = 0] = "InitialDelay", e[e.ExtendStreaks = 1] = "ExtendStreaks", e[e.ShineExtendedStreaks = 2] = "ShineExtendedStreaks", e[e.FadeInUnextendedStreaks = 3] = "FadeInUnextendedStreaks", e[e.Final = 4] = "Final"
			}(b || (b = {}));
			const I = ({
				friendStreakData: e,
				onMount: t,
					...
					O = (0, x.v)({
						getAnimationStepProperties: e => {
							switch (e[0]) {
								case b.InitialDelay:
									return {
										duration: 500, nextState: [b.ExtendStreaks, {
											startFlame: !1,
											streakIndex: 0
										}]
									};
								case b.ExtendStreaks:
									return e[1].startFlame ? e[1].streakIndex < I.length - 1 ? {
										duration: 150,
										nextState: [b.ExtendStreaks, {
											startFlame: !1,
											streakIndex: e[1].streakIndex + 1
										}]
									} : {
										duration: 400,
										nextState: [b.ShineExtendedStreaks]
									} : {
										duration: 300,
										nextState: [b.ExtendStreaks, {
											startFlame: !0,
								...
								case b.ShineExtendedStreaks:
									return {
										duration: 800, nextState: L ? [b.FadeInUnextendedStreaks] : [b.Final]
									};
								case b.FadeInUnextendedStreaks:
									return {
										duration: 500, nextState: [b.Final]
									};
								case b.Final:
									return;
								default:
									return void (0, w.RJ)(e)
							}
						},
						initialAnimationState: P && !A ? [b.InitialDelay] : [b.Final]
					});
				return s.createElement(p.Z, null, s.createElement("h2", {
					className: "_2dVRQ"
				}, I.length > 0 ? (0, R._i)(52901, {
					num: I.length
				}) : (0, R._i)(53565, {
					num: D.length
					...
					const e = O[0] >= b.ShineExtendedStreaks && O[0] <= b.FadeInUnextendedStreaks;
					...
					className: r()("_2c_k_", {
						_3juS_: O[0] < b.ShineExtendedStreaks
					})
				}, I.map((({
					friend: e,
					streak: t
				}, a) => {
					const r = O[0] > b.ExtendStreaks || O[0] === b.ExtendStreaks && a <= O[1].streakIndex,
						i = r && !(O[0] === b.ExtendStreaks && a === O[1].streakIndex && !O[1].startFlame);
					...
					className: r()({
						[E]: O[0] < b.FadeInUnextendedStreaks,
						"_3VEF6 _3Cyk6": O[0] === b.FadeInUnextendedStreaks
					})
				}, D.map((({
					friend: e,
					streak: t
					...
					variant: "outline"
				}, t.nudgedToday || C.includes(e.id) ? (0, R._i)(53876) : (0, R._i)(53875))))))) : null)
			},
				D = ({
					friendStreakData: e
				}) => {
					...
					return s.createElement(I, {
						friendStreakData: e,
						onMount: ({
							numExtendedStreaks: e,
							numUnextendedStreaks: t
						}) => {
							(0, F.track)("friend_streak_update_se_shown", {
		...
		27755: (e, t, a) => {
			...
			const p = ({
				...
				return n.createElement("div", {
					...
					displaySize: 58,
					forceNoPicture: (0, m.z_)(t.picture),
					size: "xlarge",
					user: t
				}), n.createElement(r.Z, {
					direction: "left",
		...
		46714: (e, t, a) => {
			...
			const p = ({
				...
				var h;
				const f = (0, s.Z)(),
					_ = null !== (h = (0, u.Fx)(l.Cu)) && void 0 !== h ? h : 0;
				return n.useEffect((() => {
					var a;
					t && (0, m.track)("friends_quest_complete_show", {
					...
					className: "fsQYY"
				}, (0, d._i)(t ? 36414 : 35916)), n.createElement(r.Z, null, n.createElement(o.Z, {
					animateBar: !f,
					isChestOpen: !1,
					metric: a,
					questFailed: !1,
		...
		68950: (e, t, a) => {
			...
			const s = ({
				...
				const i = [];
				return e.forEach((e => {
					e[0] !== s && i.push([a.slice(s, e[0]), !1]), i.push([a.slice(e[0], e[1]), !0]), s = e[1]
				})), s !== a.length && i.push([a.slice(s, a.length), !1]), n.createElement("span", null, i.map(((e, a) => e[1] ? n.createElement("span", {
		...
		66720: (e, t, a) => {
			...
			const y = ({
				...
				const w = (0, m.Z)(),
					...
					F = (0, s.Z)();
				if (!(null == N ? void 0 : N.active) || !(null === (y = null == N ? void 0 : N.leaderboard) || void 0 === y ? void 0 : y.activeContest)) throw Error("Leaderboard session end cannot be shown without an active leaderboard");
				const {
					cohortSize: I,
					numDemoted: D,
					numPromoted: P,
					numLosers: L,
					numWinners: A
				} = N.leaderboard.activeContest.ruleset, O = null !== (S = N.active.cohort.tier) && void 0 !== S ? S : N.tier, M = "tournament" === (null == T ? void 0 : T.alias) || O !== N.tier, Z = M ? (0, p.H8)(_.Ri[N.tier]) : (0, p.H8)(_.Vq[N.tier]), z = N.active.cohort.rankings, U = N.active.userId, G = (0, f.Tm)(z, U), B = (() => {
					if (0 === G && "leaderboardJoin" !== e) return (0, p._i)(23511, {
						league: Z
					});
					switch (e) {
						...
						case "leaderboardMoveUpPrompt":
							if (G <= 0) throw Error("leaderboardMoveUpPrompt can only be shown if user is not rank 1");
							return (0, p._i)(30155, {
								num: z[G - 1].score - z[G].score
							});
						default:
							return (0, u.RJ)(e), null
					}
				})();
				n.useEffect((() => {
				...
				const H = M && O === (null == P ? void 0 : P.length) ? A : (0, f.PR)(O, P),
					W = M && 0 === O ? L : (0, f.hn)(O, D),
					X = n.useRef(0);
				X.current += 1;
				const V = n.useRef(!1);
				return n.useEffect((() => {
					...
					n && !V.current && (V.current = !0, (0, k.Kp)("LeaderboardSlide expected user to have moved up but they have not", {
						data: {
					...
					})), !n && V.current && (V.current = !1, (0, k.Kp)("LeaderboardSlide recovered from invalid move up state", {
						data: {
							currentUserPosition: G,
							currentUserScore: z[G].score,
							lastPositionSeen: t,
					...
					currentTime: w,
					targetTime: null === (C = null === (b = N.leaderboard) || void 0 === b ? void 0 : b.activeContest) || void 0 === C ? void 0 : C.contestEnd
		...
		34107: (e, t, a) => {
			...
			var l = a(68903);
			const c = [
				[4, 4, 8, 8, 16, 24, 20, 18, 16, 20, 20, 16, 8, 4],
				[4, 4, 8, 8, 16, 24, 16, 24, 12, 20, 20, 12, 16, 4],
				[4, 24, 21, 8, 16, 24, 14, 24, 20, 14, 20, 8, 8, 4],
				[4, 4, 8, 8, 16, 8, 16, 24, 24, 16, 16, 20, 8, 4], o.nO[0]
			];
			var d;
			! function (e) {
				e[e.WAVEFORM_1 = 0] = "WAVEFORM_1", e[e.WAVEFORM_2 = 1] = "WAVEFORM_2", e[e.WAVEFORM_3 = 2] = "WAVEFORM_3", e[e.WAVEFORM_4 = 3] = "WAVEFORM_4"
			}(d || (d = {}));
			const u = [d.WAVEFORM_1, d.WAVEFORM_2, d.WAVEFORM_3, d.WAVEFORM_4],
				m = n.forwardRef((({
					color: e,
					waveformNum: t
				}, a) => n.createElement(n.Fragment, null, n.createElement(i.Z, {
					className: "tE4f1",
					color: e,
					ref: a,
					type: "small"
				}), n.createElement(r.Z, {
					amplitudes: c[t].map((e => (0, s.bA)(e, 4, 4 === t ? 32 : 24, 0, 1))),
					barWidth: 3,
		...
		93301: (e, t, a) => {
			...
			const m = () => s.createElement("div", {
				...
				...(0, c._q)(d.V.MilestoneStreakFreezeSlide)
			}, s.createElement("div", {
		...
		68891: (e, t, a) => {
			...
			var v = a(50498),
				...
				E = a(18804),
				y = a(79465);
			const S = [49866, 49867, 49868, 49869, 49870, 49871, 49872, 49873, 49874, 49863, 49864, 49865],
				b = ({
					oldProgress: e,
					onClose: t
				}) => {
					const a = (0, E.tX)(),
						...
						R = (0, E.Fx)(m.oO),
						T = (0, E.Fx)(m.gD),
						N = T ? (0, k.br)(R[T]) : void 0,
						F = (0, E.Fx)(m.Ap),
						[I, D] = s.useState(!1);
					if (s.useEffect((() => {
						const e = new AbortController;
						return (async () => {
							await (0, v._v)(300), e.signal.aborted || D(!0)
						})(), () => e.abort()
					}), []), !w) return null;
					...
					return s.createElement("div", {
					...
					}, (0, _._i)(S[b]))), s.createElement("div", {
						className: "_3ZA_u"
					}, s.createElement("div", {
						...
						onClick: () => {
							(0, y.track)("chess_nov_monthly_challenge_tap", {
								target: "no_thanks"
							}), a({
								type: "sessionEnd/CTA_CLICK"
							}), t()
					...
					}, (0, _._i)(6821)), s.createElement(c.ZP, {
						className: r()((0, l.yO)({
							color: "snow",
							variant: "solid"
						}), g),
						...
						onClick: e => {
							confirm((0, _.H8)(49502)) ? (0, y.track)("chess_nov_monthly_challenge_tap", {
								target: "claimed"
							}) : ((0, y.track)("chess_nov_monthly_challenge_tap", {
						...
						target: "_blank"
					}, (0, _._i)(5473))) : s.createElement(o.Z, {
						className: g,
						color: "snow",
						onClick: () => {
							a({
		...
		9069: (e, t, a) => {
			...
			const f = ({
				...
				const n = (0, h.Fx)(c.TE),
					...
					k = (0, h.Fx)(c.oO),
					E = (0, h.Fx)(c.gD),
					y = E ? (0, v.br)(k[E]) : void 0,
					[S, b] = s.useState("ready");
				if (s.useEffect((() => {
					const t = new AbortController;
					return "ready" === S && e && (async () => {
						b("playing"), await (0, m._v)(200), t.signal.aborted || b("finished")
					})(), () => t.abort()
				}), [e]), (0, l.Z)(a), !n) return null;
				const C = "dark" === f ? null == n ? void 0 : n.darkModeColors.primary : null == n ? void 0 : n.lightModeColors.primary,
					w = (0, v.oo)(n),
					x = [(0, g._i)(49839), (0, g._i)(49840), (0, g._i)(49841), (0, g._i)(49842), (0, g._i)(49843), (0, g._i)(49844), (0, g._i)(49845), (0, g._i)(49846), (0, g._i)(49847), (0, g._i)(49848), (0, g._i)(49849), (0, g._i)(49850)],
					R = (0, p.Ux)().getMonth();
				return s.createElement("div", {
		...
		16364: (e, t, a) => {
			...
			const x = ({
				color: e,
				coachDuoModel: t,
				currentSessionEndSlide: a,
				isSubmittable: n,
				onClick: c,
				overrideRibbonColor: d,
				smartTip: u,
				status: m
			}) => {
				const x = null == a ? void 0 : a.type,
					...
					I = {
						...
						earlyStreakMilestonePrompt: {
							className: h.Z.blue,
							content: () => (0, y._i)(31372)
						},
						finalLevelFailed: {
							className: h.Z["legendary-gold-cta"],
							content: () => (0, y._i)(28652)
						},
						finalLevelPartialXp: {
							className: h.Z["legendary-gold-cta"]
						},
						friendsQuestComplete: {
							className: h.Z.blue,
							content: () => (0, y._i)(35767, {
								name: "friendsQuestComplete" === (null == a ? void 0 : a.type) ? a.friendUser.displayName : ""
							})
						},
						friendsQuestGift: {
							className: h.Z.blue,
							content: () => s.createElement(s.Fragment, null, (0, y._i)(37905), s.createElement("span", {
								className: h.Z["gems-cost-text"]
							}, s.createElement("img", {
								src: T ? g : v
							}), s.createElement("span", null, E.py)))
						},
						friendsQuestProgress: {
							className: h.Z.blue,
							content: () => "friendsQuestProgress" === (null == a ? void 0 : a.type) && a.attachedSlides.length > 0 ? (0, y._i)(42364, {
								name: a.friendUser.displayName
							}) : (0, y._i)(4906)
						},
						friendsQuestReward: {
							className: h.Z.blue,
							content: () => (0, y._i)(35014, {
								num: E.fw
							})
						},
						mistakesInboxEmpty: {
							className: h.Z["super-cta"],
							content: () => (0, y._i)(19889)
						},
						streakExtended: {
							className: "force-undefined" === d ? h.Z.blue : d === l.Il.ORANGE_DYNAMIC ? h.Z["white-dynamic"] : (0, C.FD)(a) ? h.Z.blue : "streakExtended" === (null == a ? void 0 : a.type) && a.isEndOfPerfectWeek && !(0, b.pS)(a.streak) ? h.Z.white : "streakExtended" === (null == a ? void 0 : a.type) ? h.Z.blue : void 0,
							content: () => (0, C.FD)(a) ? (0, y._i)(45067) : "streakExtended" !== (null == a ? void 0 : a.type) || 1 !== a.perfectWeekDay && 4 !== a.perfectWeekDay ? (0, y._i)(4906) : (0, y._i)(31372)
						},
						streakFreezeGift: {
							className: h.Z.blue,
							content: () => (0, y._i)(7698)
					...
					P = (() => {
						...
						switch (m) {
							case _.c.Blaming:
								return u ? (0, y._i)(24742) : (0, y._i)(4906);
							...
							case _.c.EndCarousel: {
								if (!x) return (0, y._i)(4906);
								if ("dailyRefreshOnboarding" === x) return (0, y._i)(41039);
								const a = null === (t = null === (e = I[x]) || void 0 === e ? void 0 : e.content) || void 0 === t ? void 0 : t.call(e);
								return null != a ? a : (0, y._i)(4906)
							}
							case _.c.Grading:
							case _.c.Guessing:
							case _.c.Sliding:
							...
							case _.c.SmartTipSliding:
								return N ? (0, y._i)(11383) : (0, y._i)(17249);
							case _.c.AlphabetTipSplash:
							case _.c.GrammarSkillSplash:
								return (0, y._i)(24742);
							case _.c.Showing:
								...
								}), s.createElement("span", null, (0, y._i)(11383)));
							case _.c.UnitTestSplash:
								return (0, y._i)(1568);
							case _.c.VisiblePersonalizationSplash:
								return (0, y._i)(26);
				...
				return m === _.c.EndCarousel && (e = l.Il.GREEN), s.useEffect((() => {
					var e;
					L || m === _.c.Guessing || m === _.c.SmartTip || null === (e = F.current) || void 0 === e || e.focus()
				}), [m]), s.createElement(o.Z, {
					...(0, f._q)(k.V.PlayerNext),
					"aria-disabled": L,
		...
		47798: (e, t, a) => {
				...
				switch (o) {
					case d.c.CharacterWriteRetryBlaming:
						return e.type === p.Sm.CharacterWrite ? s.createElement(l.Sp, {
							...
							onReportClick: k,
							reported: f
						}) : ((0, u.vU)("PlayerStatus is character write retry blaming when the challenge is not a write challenge type.", {
							once: !0
					...
					case d.c.SpeakRetryBlaming:
						return e.type === p.Sm.Speak || e.type === p.Sm.ListenSpeak ? s.createElement(l.x_, {
							...
							onReportClick: k,
							reported: f
						}) : ((0, u.vU)("PlayerStatus is speak retry blaming when the challenge is not a speaking challenge type.", {
							once: !0
						}), s.createElement(l.xl, {
							challenge: e,
							color: t,
					...
					case d.c.Blaming: {
						if ((0, c.$l)(n)) return s.createElement(l.rQ, {
							challenge: e,
							color: t,
							correct: a,
							onReportClick: k,
			...
			const _ = a.p + "images/e786c05c2a908e9f919f51fb14fc950c.svg",
				...
				E = a.p + "images/196ca8dbd13236da855ff6b58ace4bee.svg",
				y = a.p + "images/ed8f358a87ca3b9ba9cce34f5b0e0e11.svg",
				S = a.p + "images/be630f7bdd8684e1a26805ea5fa93e01.svg",
				b = a.p + "images/4585c00fda1c7aea505df729918e31a3.svg",
			...
			const F = ({
				...
				return s.createElement(i.Z, {
					...
					disabled: e,
					onClick: o,
					...(0, x._q)(R.V.PlayerToggleKeyboard)
				}, s.createElement("img", {
					alt: "",
					className: "_1RJAN",
					src: l
			...
			const M = ({
				...
				return s.useEffect((() => {
					...
					disabled: t,
					onClick: t => {
						(0, L.j6)("math_in_lesson_help_tts_web", "open_tree"), (0, O.track)("math_help_button_tap", {
							challenge_id: e,
							math_help_type: o,
			...
			const G = ({
				...
				const l = void 0 !== e.supportCenterInfo && "" !== e.supportCenterInfo && "experiment" === (0, L.j6)("math_in_lesson_support_web", "help_shown"),
					c = void 0 !== n && (0, Z.I)(e.challengeBlob.layout),
					d = !l && a,
					u = s.useMemo((() => (0, z.K)((0, z.Y)(e.supportCenterInfo))), [e.supportCenterInfo]);
				return s.useEffect((() => {
					d && (0, A.Kq)(e.id)
				}), [e.id, d]), l ? s.createElement(M, {
					challengeId: e.id,
					disabled: t,
			...
			var X, V = a(44637),
				...
				K = a(42340);
			! function (e) {
				e.GREEN = "green", e.RED = "red", e.YELLOW = "yellow", e.ORANGE = "orange", e.ORANGE_DYNAMIC = "orange-dynamic"
			}(X || (X = {}));
			const j = e => e.type === p.Sm.MathChallengeBlob,
				...
				J = ({
					...
					smartTip: U,
					status: Y,
					visibility: J = "visible"
				}) => {
					const ee = (0, N.Fx)(B.Al),
						te = () => {
							var t, a, n, r, s, i;
							if (void 0 !== L) {
								if ("force-undefined" === L) return;
								return L
							}
							if (!0 === e.skipped && !0 === (null === (t = e.gradingResult) || void 0 === t ? void 0 : t.correct) || Y === d.c.SpeakRetryBlaming || Y === d.c.MathRetryBlaming) return X.YELLOW;
							const o = null === (a = e.gradingResult) || void 0 === a ? void 0 : a.guess;
							return !(0, K.uj)(o) || "suboptimal" !== (null === (n = o.gradingState) || void 0 === n ? void 0 : n.type) && "stalemate" !== (null === (r = o.gradingState) || void 0 === r ? void 0 : r.type) ? (0, K.Gu)(o) && "completed" === (null === (s = o.matchState) || void 0 === s ? void 0 : s.status) && "draw" === (null === (i = o.matchState) || void 0 === i ? void 0 : i.outcome) ? X.YELLOW : "streakExtended" === (null == l ? void 0 : l.type) && l.isEndOfPerfectWeek && !(0, q.pS)(l.streak) ? X.ORANGE : void 0 : X.YELLOW
						},
						{
							blame: ae,
							correct: ne
							...
							switch (o) {
								...
								case d.c.SpeakRetryBlaming:
								case d.c.Blaming: {
									if (null === (l = null == e ? void 0 : e.gradingResult) || void 0 === l ? void 0 : l.multiStepIsDialogue) return {
										blame: null,
										correct: void 0
									};
						...
						se = Z ? (({
							...
							onLeftButtonClick: g,
							onSessionStart: v,
							onShowInLessonTipClick: h,
							onSkipButtonClick: f,
							session: _,
							sessionParams: k,
							status: E
						}) => {
							const y = s.createElement(i.Z, {
								className: W.review,
								onClick: () => {
									n({
										options: {
										...
										type: "TOGGLE_MODAL"
									}), (0, O.track)("review_lesson_click", {
										target: "open"
									})
								},
								variant: "stroke"
							}, (0, T._i)(19304)),
								S = s.createElement(i.Z, {
									className: W.review,
									onClick: () => {
										n({
											options: {
											...
											type: "TOGGLE_MODAL"
										}), (0, O.track)("duo_radio_episode_end", {
							...
							switch (E) {
									...
									switch (null == a ? void 0 : a.type) {
										...
										case "streakExtended":
											return a.isEndOfPerfectWeek ? null : "streakExtended" === a.type && a.showEarnbackOffer ? s.createElement(i.Z, {
												className: W.review,
												color: "macaw",
												...(0, x._q)(R.V.ContinueButton),
												onClick: g,
												variant: "stroke"
											}, (0, T._i)(4906)) : _.type === p.FF.DuoRadio && _.transcript ? S : !o || _.type === p.FF.DuoRadio || j(e) || (0, Q.M4)().includes(e.type) ? null : y;
										default:
											return _.type === p.FF.DuoRadio && _.transcript ? S : !o || _.type === p.FF.DuoRadio || j(e) || (0, Q.M4)().includes(e.type) ? null : y
									}
								case d.c.Blaming:
								case d.c.Grading:
								case d.c.Guessing:
								case d.c.Showing:
								case d.c.Sliding: {
									const a = E !== d.c.Guessing;
									if (o && a) return null;
									if (j(e)) return s.createElement(G, {
										challenge: e,
										disabled: a,
										isMathHintAvailable: l,
										onCalculatorClick: c,
									...
									return n ? s.createElement(i.Z, {
										...(0, x._q)(R.V.PlayerSkip),
										className: W.skip,
										disabled: a,
										onClick: f,
										variant: "stroke"
									}, (0, T._i)("cant-listen" === n ? 16837 : "cant-speak" === n ? 14082 : 12500)) : r && !k.isFinalLevel ? s.createElement(i.Z, {
								...
								case d.c.GrammarSkillSplash:
									return s.createElement(i.Z, {
										...
										color: "macaw",
										onClick: () => {
											(0, O.track)("explanation_ad_cancel", {
												alphabet_id: k.alphabetId,
												is_grammar_skill: E === d.c.GrammarSkillSplash
											}), v()
										},
										variant: "stroke"
									}, (0, T._i)(7058));
						...
						ie = (() => {
							if (!Z) return W["footer-content-container"];
							switch (Z.type) {
					...
					const le = Z ? (({
						challenge: e,
						hasTrackedEmaButtonShowRef: t,
						isDesktop: a,
						isEarnback: n,
						isZombieMode: r,
						onShowMathGradingFeedbackClick: o,
						remount: l,
						session: c,
						status: u
					}) => {
						...
						switch (u) {
							...
							case d.c.Blaming:
								if (j(e)) {
									...
									if (a) {
										...
										return t.current || (t.current = !0, (0, A.r_)(a)), s.createElement(i.Z, {
							...
							case d.c.EndCarousel:
								return a && !r && c && c.type === p.FF.GlobalPractice && !n ? s.createElement(i.Z, {
									...(0, x._q)(R.V.PlayerPracticeAgain),
		...
		38545: (e, t, a) => {
			...
			var v, h;
			! function (e) {
				e[e.EMPTY = 0] = "EMPTY", e[e.LINGOTS = 1] = "LINGOTS", e[e.GEMS = 2] = "GEMS", e[e.XP_BOOST = 3] = "XP_BOOST", e[e.STREAK_FREEZE = 4] = "STREAK_FREEZE", e[e.DOUBLE_STREAK_FREEZE = 5] = "DOUBLE_STREAK_FREEZE"
			}(v || (v = {})),
				function (e) {
			...
			const f = (e, t) => {
				switch (t) {
					...
					case v.STREAK_FREEZE:
						switch (e) {
							...
							case h.GOLD:
								return r;
							default:
								return (0, m.Kp)("No fallback found for rive chest", {
									data: {
										color: e,
										type: t
									},
					...
					case v.XP_BOOST:
						return e === h.GOLD || (0, m.Kp)("No fallback found for rive chest", {
							data: {
								color: e,
								type: t
							},
				...
				_ = ({
					...
					const {
						...
						src: d,
						stateMachines: g
					}), l = (0, p.useStateMachineInput)(o, g, "open");
					return (0, p.useStateMachineInput)(o, g, "Chest_MetalColor", e), (0, p.useStateMachineInput)(o, g, "Chest_RewardType", s), n.useLayoutEffect((() => {
						t && (null == l || l.fire())
					}), [t]), r ? n.createElement("img", {
						className: "_2QgBA",
						src: f(e, s)
		...
		67524: (e, t, a) => {
			...
			const v = {
				...
				h = ({
					...
					const t = "dark" === (0, o.Fg)();
					return s.createElement("div", null, (0, i.DZ)(3, (a => s.createElement("img", {
			...
			var k = a(21778);
			const E = a.p + "images/icons/4f591e24f5c8b5e4411fc66e2af4dd16.svg",
				y = a.p + "images/icons/22374ccb0eddb1425a4c11b2bef1bcc8.svg",
				S = a.p + "images/icons/6ec44f331f5eb4c68e57cd7874332c6c.svg",
				b = a.p + "images/icons/db8690b9819fbf836887442f130e3641.svg",
			...
			var j;
			! function (e) {
				e[e.READY = 0] = "READY", e[e.BASE_XP = 1] = "BASE_XP", e[e.BONUS_XP = 2] = "BONUS_XP", e[e.BOOST_XP = 3] = "BOOST_XP", e[e.ACCURACY = 4] = "ACCURACY", e[e.MATCHES = 5] = "MATCHES", e[e.CHESS_MATCHES = 6] = "CHESS_MATCHES", e[e.CHESS_ELO = 7] = "CHESS_ELO", e[e.FINISHED = 100] = "FINISHED"
			}(j || (j = {}));
			const $ = 900,
				J = 300,
				ee = {
				...
				te = ({
					...
					const F = (0, d.Z)(),
						I = "dark" === (0, o.Fg)(),
						[D, P] = s.useState(F ? j.FINISHED : j.READY),
						[L] = s.useState(K[Math.floor(Math.random() * K.length)]),
						U = T,
						B = p ? U / q.K3 : U,
						X = B - Math.max(n, 0),
						V = (0, Q.CC)(),
						te = s.useRef(0);
					te.current += 1, s.useEffect((() => {
						"number" == typeof U && "number" == typeof X && "number" == typeof B && U >= 0 && X >= 0 && B >= 0 || (0, W.Kp)("Invalid XP gain values shown on session end", {
							data: {
								animationState: D,
								bonusXp: n,
								hasXpBoost: p,
								player: i.ei((0, f.lA)(V.getState()), "enableBonusPoints", "endedEarly", "partialXpGiven"),
								renderCount: te.current,
								session: i.ei((0, f.is)(V.getState()), "id", "type"),
								xpGain: U,
								xpGainWithoutBonus: X,
					...
					const ae = (0, z.Ar)({
						...
						ne = x === Y.FF.MathMatchPractice;
					s.useEffect((() => {
						const e = new AbortController;
						let t = D;
						return g && (async () => {
							t === j.READY && (t = j.BASE_XP, P(j.BASE_XP));
							const a = void 0 === m ? void 0 === u ? j.FINISHED : j.CHESS_ELO : j.CHESS_MATCHES,
								r = ae ? a : j.ACCURACY;
							if (t === j.BASE_XP)
								if (n > 0) {
									if (await (0, M._v)(900), e.signal.aborted) return;
									t = j.BONUS_XP, P(j.BONUS_XP)
								} else {
									if (await (0, M._v)(p ? 900 : $), e.signal.aborted) return;
									t = p ? j.BOOST_XP : r, P(t)
								} if (t === j.BONUS_XP) {
									if (await (0, M._v)(p ? 650 : 1050), e.signal.aborted) return;
									t = p ? j.BOOST_XP : r, P(t)
								}
							if (t === j.BOOST_XP) {
								if (await (0, M._v)(1050), e.signal.aborted) return;
								t = r, P(t)
							}
							if (t === j.ACCURACY) {
								if (await (0, M._v)($), e.signal.aborted) return;
								t = void 0 === v ? j.FINISHED : j.MATCHES, P(t)
							}
							if (t === j.MATCHES) {
								if (await (0, M._v)($), e.signal.aborted) return;
								t = j.FINISHED, P(t)
							}
							if (t === j.CHESS_MATCHES) {
								if (await (0, M._v)($), e.signal.aborted) return;
								t = void 0 === m ? j.FINISHED : j.CHESS_ELO, P(t)
							}
							if (t === j.CHESS_ELO) {
								if (await (0, M._v)($), e.signal.aborted) return;
								t = j.FINISHED, P(t)
					...
					const re = a < 85 ? (0, H._i)(10174) : a < 90 ? (0, H._i)(18235) : a < 100 ? (0, H._i)(11684) : (0, H._i)(42030),
						se = (0, H.H8)(29158, {
							percent: a
						}),
						ie = (0, H.H8)(29158, {
						...
						oe = F ? ee : {},
						le = U.toString().length - X.toString().length,
						ce = p && D >= j.BOOST_XP,
						de = ne || ae;
					return s.createElement("div", {
						className: r()(A.Z.slide, O.slide)
					}, s.createElement("div", {
						...(0, Z._q)(G.V.SessionCompleteSlide)
						...
						isPlaying: g && !F,
						loop: !0,
						loopSegment: L.loopSegment,
						mainSegment: F ? [L.stillFrame, L.loopSegment[1]] : void 0,
						path: L.path
					})) : s.createElement("div", {
						...
						className: O.title
					}, null != t ? t : N), e ? s.createElement("div", {
						className: O.accolade
					}, e) : null), s.createElement("div", {
						className: O["stat-container"]
					}, D >= j.BASE_XP ? s.createElement("div", {
						className: r()(O["stat-item"], de && O["stat-item-crowded"])
					}, s.createElement("div", {
						className: O[ce ? "stat-item-background-xp-boost" : "stat-item-background-xp"],
						style: {
						...
						style: oe
					}, n > 0 && D < j.BOOST_XP ? (0, H._i)(36099) : p && D < j.ACCURACY ? (0, H._i)(36100) : (0, H._i)(3372)), s.createElement("div", {
						className: O[ce ? "stat-item-inner-xp-boost" : "stat-item-inner-xp"],
						style: oe
					}, s.createElement("img", {
						className: O["xp-icon"],
						src: k,
					...
					}), n > 0 && D < j.BONUS_XP ? s.createElement(c.Z, {
						animationDelay: 250,
						animationDuration: J,
						initialValue: "0",
						key: 0,
						...
						result: X.toString(),
						rtl: H.lw
					}) : p && D < j.BOOST_XP ? s.createElement(c.Z, {
						animationDelay: n > 0 ? 0 : 250,
						animationDuration: J,
						initialValue: n > 0 ? X.toString() : "0",
						key: 1,
						prefersReducedMotion: F,
						result: B.toString(),
						rtl: H.lw
						...
						animationDuration: J,
						initialValue: p ? B.toString() : n > 0 ? X.toString() : "0",
						key: 2,
						prefersReducedMotion: F,
						result: U.toString(),
						rtl: H.lw
					}))) : null, !ae && D >= j.ACCURACY ? s.createElement("div", {
						className: r()(O["stat-item"], de && O["stat-item-crowded"])
					}, s.createElement("div", {
						...
						result: se,
						rtl: H.lw
					}))) : ae ? null : s.createElement("div", {
						className: O["stat-item-invisible"]
					}), !ae && void 0 !== v && D >= j.MATCHES ? s.createElement("div", {
						className: r()(O["stat-item"], de && O["stat-item-crowded"])
					}, s.createElement("div", {
						...
						className: O["stat-description"],
						style: oe
					}, (0, H._i)(48687)), s.createElement("div", {
						...
						result: v.toString(),
						rtl: H.lw
					}))) : ae || void 0 === v ? null : s.createElement("div", {
						className: O["stat-item-invisible"]
					}), ae && void 0 !== m && D >= j.CHESS_MATCHES ? s.createElement("div", {
						...
						result: m.toString(),
						rtl: H.lw
					}))) : null, ae && "number" == typeof u && D >= j.CHESS_ELO ? s.createElement("div", {
						className: r()(O["stat-item"], O["stat-item-crowded"])
					}, s.createElement("div", {
						className: O["stat-item-background-accuracy"],
						style: oe
						...
						className: O["stat-description"],
						style: oe
					}, (0, H._i)(66499)), s.createElement("div", {
						className: O["stat-item-inner-accuracy"],
						style: oe
					}, s.createElement("img", {
						className: O["stat-icon-big-gap"],
						...
						result: u.toString(),
						rtl: H.lw
					}))) : ae && void 0 !== u ? s.createElement("div", {
						className: O["stat-item-invisible"]
					}) : null))
				},
				ae = ({
					...
					player: {
						...
						chessMatchCount: n,
						levelData: r,
						matchMadnessMatchesCompleted: o,
						session: l,
						session: {
							challenges: c,
							endTime: d,
					...
					xpSessionProgress: {
						bonusXp: _,
						hasXpBoost: k,
						totalXpThisSession: E
					}
				}) => {
					var y;
					const S = (0, Q.Fx)(f.Al),
						b = (0, Q.Fx)(f.Oz),
						C = "chess" === (null == b ? void 0 : b.subject),
						w = (() => {
							if (p === Y.FF.DuoRadio) return (0, U.a1)(l);
							if (p === Y.FF.MathMatchPractice) {
								const e = (0, V.U2)(c);
								return 0 === e ? 0 : Math.round(o / e * 100)
							}
							return C ? (0, V.ZM)(c) : void 0 === S ? (0, V.sG)(c, t) : Math.round(S.numChallengesCorrect / S.totalChallenges * 100)
						})(),
						x = null !== (y = null == S ? void 0 : S.totalXp) && void 0 !== y ? y : E,
						R = Math.floor(v > 0 ? v : d - m),
						[
							[T, N]
						] = s.useState((() => {
							var e, t, a;
							if (p === Y.FF.LexemePractice && "lexeme" === (null == g ? void 0 : g.contextType) && (null === (e = null == g ? void 0 : g.focusedLexemes) || void 0 === e ? void 0 : e.length) > 0) return [(0, H._i)(46781), (0, H._i)(46784, {
								num: g.focusedLexemes.length
							})];
							if (p === Y.FF.LexemePractice && "grammar" === (null == g ? void 0 : g.contextType)) return [(0, H._i)(48384), (0, H._i)(48265)];
							if (100 === w) return [(0, H._i)(9211), (0, H._i)(40104)];
							const n = [];
							R < 120 ? n.push([(0, H._i)(40095), (0, H._i)(40102, {
								num: Math.ceil(R / 60)
							})]) : R > 420 && n.push([(0, H._i)(40096), (0, H._i)(40103, {
								num: Math.floor(R / 60)
							})]);
							const r = (0, V.dM)(c);
							r >= 3 && n.push([(0, H._i)(40097), (0, H._i)(40105, {
								num: r
							})]), x >= 30 && n.push([(0, H._i)(40098), (0, H._i)(40106, {
								num: x
							})]);
							const s = (0, V.tJ)(c);
							s >= 3 && n.push([(0, H._i)(40099), (0, H._i)(40107, {
								num: s
							})]);
							const i = p === Y.FF.DuoRadio ? null !== (a = null === (t = l.duoRadioChallengeStats) || void 0 === t ? void 0 : t.numListenChallengesCorrect) && void 0 !== a ? a : 0 : (0, V.Ok)(c);
							i >= 3 && n.push([(0, H._i)(40100), (0, H._i)(40108, {
								num: i
							})]);
							const o = (0, V.EW)(p, c);
							return o >= 6 && n.push([(0, H._i)(40101), (0, H._i)(40109, {
								num: o
							})]), 0 === n.length ? [void 0, void 0] : n[Math.floor(Math.random() * n.length)]
						})()),
						F = p === Y.FF.MathMatchPractice,
						I = F ? (0, V.Qn)(p, c) : void 0,
						D = F ? o : void 0,
						P = (0, z.Ar)({
							type: p
						}),
						...
						O = (() => {
							switch (p) {
								case Y.FF.AlphabetLesson:
								case Y.FF.AlphabetPractice:
								case Y.FF.ChessLesson:
								case Y.FF.ChessSession:
								case Y.FF.ChessPuzzles:
								case Y.FF.ChessUnitReview:
								case Y.FF.ChessSkill:
								case Y.FF.Lesson:
								case Y.FF.MathLesson:
								case Y.FF.MathMultiStepLesson:
								case Y.FF.MathPractice:
								case Y.FF.DuoRadio:
								case Y.FF.Placement:
								case Y.FF.Story:
									return (0, X.Wc)(null == r ? void 0 : r.level.state) ? (0, H._i)(20820) : (0, H._i)(24338);
								case Y.FF.ChessMatch:
								case Y.FF.ChessPvpMatch:
									return (0, H._i)(63814);
								case Y.FF.ChessGlobalPractice:
								case Y.FF.ChessPractice:
								case Y.FF.GlobalPractice:
								case Y.FF.LexemeSkillLevelPractice:
								case Y.FF.ListeningPractice:
								case Y.FF.MathGlobalPractice:
								case Y.FF.MathSkillPractice:
								case Y.FF.MistakesReview:
								case Y.FF.SpeakingPractice:
								case Y.FF.SpecifiedMatchPractice:
								case Y.FF.TargetPractice:
								case Y.FF.UnitRewind:
									return (0, H._i)(20820);
								case Y.FF.Legendary:
								case Y.FF.LegendaryLevel:
								case Y.FF.LegendaryLexemePractice:
								case Y.FF.LegendaryUnitPractice:
								case Y.FF.UnitReview:
								case Y.FF.MathUnitReview:
									return (0, H._i)(14273);
								case Y.FF.LevelReview:
								case Y.FF.LexemePractice:
								case Y.FF.SpacedRepetition:
								case Y.FF.UnitPractice:
									return r && (0, X.$)(r.level) ? (0, H._i)(14273) : (0, X.Wc)(null == r ? void 0 : r.level.state) ? (0, H._i)(20820) : (0, H._i)(24338);
								case Y.FF.SectionTest:
								case Y.FF.ChessSectionTest:
									if (u) throw Error("Attempting to show session complete slide for Section Test");
									return (0, H._i)(3923);
								case Y.FF.UnitTest:
								case Y.FF.ChessUnitTest:
									if (u) throw Error("Attempting to show session complete slide for CheckpointTest in v2");
									return (0, H._i)(3923);
								case Y.FF.MathMatchPractice:
									switch (I) {
										case 0:
											return (0, H._i)(48273);
										case 1:
								...
								default:
									throw (0, B.RJ)(p), Error(`Unexpected session type: ${p}`)
							}
						})(),
						M = i.VO(h.xpSummaries).reduce(((e, t) => void 0 === t ? e : e + t.numSessions), 0),
						Z = void 0 !== T && void 0 !== N && M >= 5 && (0, V.uX)(p) && void 0 === S;
					return s.createElement(te, {
						accoladeSubtitle: Z ? N : void 0,
						accoladeTitle: Z ? T : void 0,
						accuracy: w,
						bonusXp: void 0 === S ? _ : 0,
						chessElo: A,
						chessMatches: L,
						hasXpBoost: void 0 === S && k,
						isDisplayed: e,
						matchStars: I,
						matches: D,
						sessionType: p,
		...
		9096: (e, t, a) => {
			...
			const p = a.p + "images/2b5ee3319568bd4ad9aa7f1b4db88324.svg",
				...
				E = a.p + "lottie/2e35641b920ebe25a8a5653b8d926619.json",
				y = a.p + "lottie/ac2431a0ca595dc031085a1ddfe86817.json";
			var S = a(75744);
			const b = {
				calendar: "_2twSo",
			...
			const M = ({
				...
				className: r()(b["streak-goal-slide"], {
					[b["streak-goal-slide-before-slide-up"]]: a,
					[b["streak-goal-slide-not-scrollable"]]: !e
				})
			}, s.createElement("div", {
				className: r()(b["streak-goal-slide-inner"], {})
			}, t)),
				Z = (e, t = 0) => {
					const [a, n] = s.useState(), r = void 0 === a ? void 0 : e[a];
					return {
						renderButtonGroup: () => s.createElement(i.Z, {
							className: b["goal-container"],
							name: "goal",
							onChange: e => n(parseInt(e.value, 10)),
							value: `${a}`
						}, e.map((([e, t], a) => s.createElement(o.Z, {
							className: b["goal-option"],
							key: e,
							role: "radio",
							value: `${a}`
						}, s.createElement("div", {
							className: b["goal-option-text"]
						}, (0, F._i)(60216, {
							num: e
						})), s.createElement("div", {
							className: b["goal-option-label"],
							...(0, w._q)(R.V.StreakGoalOption)
						}, t))))),
			...
			var U;
			! function (e) {
				e[e.Start = 0] = "Start", e[e.Bubble = 1] = "Bubble", e[e.Options = 2] = "Options", e[e.End = 3] = "End"
			}(U || (U = {}));
			const G = e => {
				const t = (0, x.lQ)(S.i, y),
					a = (0, D.$6)(c.Z) && void 0 !== t,
					n = (0, N.v)({
						canStartAnimation: a,
						getAnimationStepProperties: e => ({
							[U.Start]: {
					...
					i = [(0, F._i)(39476), (0, F._i)(39477), (0, F._i)(39478), (0, F._i)(39479)],
					{
						renderButtonGroup: o,
						selectedStreakGoalData: l,
						selectedStreakGoalDataWithDefault: [d]
					} = Z(e.nextOptions.map(((e, t) => {
						var a;
						return [e.length, i[t], null !== (a = [2, 3, 5, 7][t]) && void 0 !== a ? a : 7, e]
					})));
				return z(e, null == l ? void 0 : l[3]), a ? s.createElement(M, {
					allowScrolling: n === U.End,
					slidDown: n < U.Options
				}, s.createElement("div", {
					className: b.header
				}, s.createElement("div", {
					className: b["header-speech-bubble"]
				}, ("streakGoalEarnback" === e.subtype ? [] : [(0, F.H8)(54166), (0, F.H8)(33820, {
					num: 10
				})]).map(((e, t) => s.createElement("div", {
					"aria-hidden": "true",
					className: b["hidden-bubble"],
					key: t
				}, s.createElement(u.Z, {
					canBeginShowing: !1,
					direction: "up",
					...
					direction: "up",
					duoQuote: "streakGoalEarnback" === e.subtype ? (0, F.H8)(49083) : void 0 === l ? (0, F.H8)(54166) : (0, F.H8)(33820, {
						num: l[2]
					}, {
						exportTags: !0
					}),
					...
					"aria-hidden": "true",
					className: r()(b["header-calendar-text"], {
						[b["header-calendar-text-long"]]: d >= 100,
						[b["header-calendar-text-very-long"]]: d >= 1e3
					})
				}, d))), o()) : null
			};
			var B;
			! function (e) {
				e[e.Start = 0] = "Start", e[e.Progress = 1] = "Progress", e[e.CalendarFlame = 2] = "CalendarFlame", e[e.RewardTextIn = 3] = "RewardTextIn", e[e.RewardTextOut = 4] = "RewardTextOut", e[e.ScaleCalendar = 5] = "ScaleCalendar", e[e.NextOptions = 6] = "NextOptions", e[e.FocusNext = 7] = "FocusNext", e[e.FocusNextShine = 8] = "FocusNextShine", e[e.End = 9] = "End"
			}(B || (B = {}));
			const H = e => {
				var t;
				const a = "dark" === (0, l.Fg)(),
					...
					{
						renderButtonGroup: m,
						selectedStreakGoalData: y
					} = Z("streakGoalComplete" === e.subtype ? e.nextOptions.map(((t, a) => [t.length, (0, F._i)(47831, {
						num: (0, L.Jm)(e.currentStreak, t)
					}), a, t])) : []);
				if (z(e, null == y ? void 0 : y[3]), s.useEffect((() => {
					var t;
				...
				const C = (e, t, o) => s.createElement("div", {
					className: r()(b.calendar, {
						[b["calendar-focus"]]: "next" === o && u >= B.FocusNext,
						[b["calendar-scale-up"]]: "animated" === o && u >= B.CalendarFlame && u < B.FocusNext || "option-selected" === o && void 0 !== y,
						[b["calendar-scale-down"]]: "animated" === o && u > B.RewardTextOut,
						[b["calendar-scale-down-fast"]]: "option" === o && void 0 !== y
					}),
					key: e,
					style: {
					...
					switch (o) {
						...
						case "animated":
							return s.createElement(s.Fragment, null, s.createElement(c.Z, {
								...
								className: r()(b["calendar-text"], {
									[b["calendar-text-fade-out"]]: u >= B.CalendarFlame
								}),
								style: {
						...
						case "next":
							return s.createElement(s.Fragment, null, s.createElement(c.Z, {
								animationData: i,
								className: b["calendar-sheen"],
								isPlaying: u >= B.FocusNextShine
							}), s.createElement("div", {
								className: r()(b["calendar-text"], {
									[b["calendar-text-sheen"]]: u >= B.FocusNextShine
								}),
								style: {
									"--streak-calendar-num-digits": `${t}`.length
								}
						...
						case "static": {
							const e = ("option" === o || "option-selected" === o) && void 0 !== y;
							return s.createElement(s.Fragment, null, s.createElement("div", {
								className: b["calendar-frame"]
							}, s.createElement("img", {
								className: b["calendar-frame-image"],
								src: a ? v : h
							}), s.createElement("img", {
								className: r()(b["calendar-frame-image-active"], {
									[b["calendar-frame-image-active-hidden"]]: !e
								}),
								src: a ? p : g
							})), s.createElement("div", {
								className: r()(b["calendar-text"], {
									[b["calendar-text-option"]]: e
								}),
								style: {
									"--streak-calendar-num-digits": `${t}`.length
								}
				...
				return s.createElement(M, {
					...
					className: r()(b.timeline, {
						[b["timeline-move-fast"]]: "streakGoalComplete" === e.subtype && u >= B.NextOptions
					}),
					style: {
						"--streak-goal-timeline-scroll": ("streakGoalCheckpoint" === e.subtype && u >= B.FocusNext ? 1 : 0) + (void 0 === y ? 0 : 1) + (null !== (t = null == y ? void 0 : y[2]) && void 0 !== t ? t : 0)
					}
				}, s.createElement("div", {
					className: b["progress-bar"]
				}, s.createElement("div", {
					className: b["progress-bar-background"]
				}), s.createElement("div", {
					className: r()(b["progress-bar-fill"], {
						[b["progress-bar-fill-offset"]]: u < B.Progress
					})
				})), u >= B.RewardTextIn && u <= B.RewardTextOut && void 0 !== e.gemReward ? s.createElement("div", {
					className: r()(b["reward-text"], {
						[b["reward-text-in"]]: u === B.RewardTextIn,
						[b["reward-text-out"]]: u === B.RewardTextOut
					})
				}, (0, F._i)(31628, {
					num: e.gemReward
				})) : null, C(-2, 0, "complete"), C(-1, 0, "complete"), C(0, e.currentStreak, "animated"), "streakGoalComplete" === e.subtype ? e.nextOptions.map(((e, t) => C(t + 1, e.length, void 0 === y ? "static" : e.length === y[0] ? "option-selected" : "option"))) : e.futureMilestones.map(((e, t) => C(t + 1, e, 0 === t ? "next" : "static"))))), s.createElement(d, {
					className: r()(b["text-container"], {
						[b["text-container-added-margin"]]: "streakGoalComplete" === e.subtype
					})
				}, "streakGoalComplete" === e.subtype ? [
					[(0, F._i)(50257), u >= B.CalendarFlame && u < B.RewardTextOut],
					[(0, F._i)(58034), u >= B.NextOptions]
				] : [
					[(0, F._i)(49431), u >= B.CalendarFlame && u < B.RewardTextOut],
					[(0, F._i)(49430), u >= B.FocusNextShine]
				]), m())
			},
				W = e => {
					switch (e.subtype) {
				...
				X = e => {
					...
					return s.createElement(W, {
						...
						onNewGoalConfirmed: e => {
							var a, r;
							(0, O.track)("new_streak_goal_confirmed", {
		...
		86107: (e, t, a) => {
			...
			const _ = ({
				...
				const i = (0, l.Z)(),
					[o, c] = s.useState(i),
					d = a && a.length > 2,
					_ = (0, u.Z)(!1, (async () => (await (0, h._v)(e), !0)), []),
					k = (0, f.pS)(n) ? [340, 480] : [90, 258],
					E = i ? t ? [30, 31] : k : t ? [30, 90] : void 0;
				return s.createElement("div", {
					...
					className: v[(0, f.pS)(n) ? "animated-flame-fire-duo" : n <= 9 ? "animated-flame-c1" : n <= 99 ? "animated-flame-c2" : n <= 999 ? "animated-flame-c3" : "animated-flame-c4"]
				}, s.createElement(m.Z, {
			...
			var k = a(67208);
			const E = a.p + "images/cb9e58c0a8bed497fcf716a64cc13521.svg";
			var y = a(96391);
			const S = a.p + "rive/c75092d1cdbfc99faa361d669ad5ba11.riv",
				b = a.p + "rive/b96b15c836fdb2c61eb77d5f15308f1d.riv";
			var C = a(75073),
				w = a(72117);
			const x = "_2k21Q",
				R = "_2ROxM",
			...
			const G = (e, t) => {
				const a = void 0 !== e.rive && null !== e.rive,
					n = t => {
						...
						if (void 0 === n) throw Error(`Input ${t} not found`);
						return n
					};
				s.useLayoutEffect((() => {
					if (a)
						for (const [e, a] of Object.entries(t)) {
							const t = n(e);
							if (void 0 === t) throw Error(`Input ${e} not found`);
							t.value = a
						}
				}), [a, e.stateMachine, (0, M.r)(t)])
			},
				B = ({
					artboard: e,
					autoplay: t,
					imperativeInputsList: a,
					layout: n,
					src: r,
					stateMachine: s
				}) => {
					const i = (0, O.useRive)({
						...
						l = e => {
							...
							if (void 0 === a) throw Error(`Input ${e} not found`);
							return a
						},
						c = o ? a.reduce(((e, t) => ({
							...e,
				...
				H = ({
					...
					let E;
					! function (e) {
						e[e.Initial = 0] = "Initial", e[e.Flame = 1] = "Flame", e[e.OdometerFadeOut = 2] = "OdometerFadeOut", e[e.BackgroundTakeover = 3] = "BackgroundTakeover", e[e.OdometerFadeIn = 4] = "OdometerFadeIn", e[e.Odometer = 5] = "Odometer", e[e.Slide = 6] = "Slide", e[e.CalendarFade = 7] = "CalendarFade"
					}(E || (E = {}));
					const y = (() => {
						switch (p.type) {
							case "normal":
							case "perfect-progress": {
								...
								return {
									[E.Flame]: {
										duration: e,
										nextState: E.Odometer
									},
									[E.OdometerFadeOut]: void 0,
									[E.BackgroundTakeover]: void 0,
									[E.OdometerFadeIn]: void 0,
									[E.Odometer]: {
										duration: 2033 - e,
										nextState: E.Slide
									},
									[E.Slide]: {
										duration: 500,
										nextState: E.CalendarFade
									},
									[E.CalendarFade]: void 0
								}
							}
							case "perfect-complete":
								return {
									[E.Flame]: {
										duration: 500,
										nextState: E.OdometerFadeOut
									}, [E.OdometerFadeOut]: {
										duration: 600,
										nextState: E.BackgroundTakeover
									}, [E.BackgroundTakeover]: {
										duration: 0,
										nextState: E.OdometerFadeIn
									}, [E.OdometerFadeIn]: {
										duration: 50,
										nextState: E.Odometer
									}, [E.Odometer]: {
							...
							default:
								throw (0, D.RJ)(p.type), Error(`Unhandled streak extension type: ${p.type}`)
						}
					})(),
						w = (0, P.v)({
							...
							getAnimationStepProperties: e => ({
								[E.Initial]: {
									duration: 300,
									nextState: o ? E.CalendarFade : E.Flame
								},
								...y
							}[e]),
							initialAnimationState: E.Initial
						}),
						F = (() => {
							if ("perfect-complete" === p.type && void 0 !== u) return o || w >= E.BackgroundTakeover ? d.Il.ORANGE_DYNAMIC : "force-undefined"
						})();
					s.useLayoutEffect((() => {
						void 0 !== F && (null == u || u(F))
					}), [F]), s.useLayoutEffect((() => () => {
					...
					return s.useEffect((() => {
						...
						...(() => {
							...
							const n = a.toString().length,
								r = t.toString().length;
							e.old_digitamount_num = n, e.new_digitamount_num = r;
							for (let s = 0; s < 4 && 0 !== t; s++)(a > 0 || 0 === s) && (e[`old_pos${n - s}_num`] = a % 10), (t > 0 || 0 === s) && (e[`new_pos${r - s}_num`] = t % 10), a = Math.floor(a / 10), t = Math.floor(t / 10);
							return e
						})()
					}), s.createElement("div", {
						...
						className: r()("R7KzO", {
							_3l3Yx: w >= E.OdometerFadeOut && w < E.OdometerFadeIn
						})
					}), s.createElement("div", {
						className: r()("Ikkcc", {
							_3Eikr: F === d.Il.ORANGE_DYNAMIC,
							_33hhf: o || w >= E.CalendarFade
						})
					}, (0, L._i)(54164, {
						num: m
					})))), s.createElement("div", {
				...
				W = ({
					...
					switch (s.useEffect((() => {
						...
						default:
							return (0, D.RJ)(d), null
					}
				},
				X = ({
					completedEarnbackStreakLength: e,
					daysInCurrentStreak: t,
					isEndOfPerfectWeek: a,
					isPerfectStreakWeekLost: n,
					...
					const _ = (0, l.Z)(),
						...
						b = S.slice(0, y).every(U.tV),
						C = null !== (h = null == p ? void 0 : p.length) && void 0 !== h ? h : 0,
						w = b && C - y > 7 && S.slice(0, y).every(U.Qb),
						x = (0, f.Q1)(k, v, E),
						R = (() => {
							if (c) {
								if (m) return (0, L._i)(52691, {
									num: m.length
								});
								(0, A.Kp)("Trying to show new streak earnback offer without streakRepairOffer", {
									once: !0
								})
							}
							const e = (0, Z.kA)(C);
							return void 0 !== e ? e : w ? (0, f.wW)(y, x, d.body) : d.body
						})();
					s.useEffect((() => {
						if (void 0 === e) {
							if (w) {
								const e = (0, f.Jo)(y),
									t = (0, f.mj)(i);
								(0, z.track)("session_end_perfect_streak_show", {
									body_copy_id: e,
								...
								}), a && (0, z.track)("session_end_perfect_streak_earned_show", {
									body_copy_id: e,
									consecutive_perfect_week: x,
									cta_copy_id: t,
									is_new_perfect_streak: 1 === x,
							...
							} (0, z.track)("session_end_streak_reached_show", {
		...
		2298: (e, t, a) => {
			...
			const g = () => {
				...
				return s.createElement("div", {
					...
					className: "_1rDL6"
				}, (0, m._i)(34808)), s.createElement("h2", {
		...
		85577: (e, t, a) => {
			...
			const m = ({
				...
				return n.createElement("div", {
					...
					className: "_1nnwE"
				}, m.toLocaleString((0, l.M$)(window.duo.uiLanguage), {
					day: "numeric",
					month: "long",
					year: "numeric"
				})), n.createElement("div", {
					...
					className: "_2RETf"
				}, (0, o._i)(49452))), n.createElement("div", {
					className: "_2nBgo"
		...
		41288: (e, t, a) => {
			...
			const h = ({
				...
				const n = (0, g.vz)(e),
					...
					E = (0, o.Z)();
				return s.useEffect((() => {
					(0, v.track)("session_end_streak_society_progress_show", {
						streak: e,
					...
					className: "_2DM1c"
				}, (0, m._i)(34808)), s.createElement("div", {
					className: "_3tiBg"
				}, s.createElement(i.Z, {
					className: "W7-uw",
					color: "bee",
			...
			const h = ({
				...
				f = ({
					...
					return s.useEffect((() => {
						...
						className: p.flair
					}, (0, g._i)(34808)), s.createElement("h2", {
		...
		25656: (e, t, a) => {
			...
			const p = () => {
				...
				return s.useEffect((() => {
					...
					className: c.flair
				}, (0, u._i)(34808)), s.createElement("h2", {
		...
		42804: (e, t, a) => {
			...
			var f, _ = a(30033),
				...
				E = a(67116);
			! function (e) {
				e.AlphabetsMedium = "alphabets-medium", e.AlphabetsLarge = "alphabets-large", e.Large = "large", e.Normal = "normal", e.Shorter = "shorter", e.StoriesInline = "stories-inline", e.SvgPuzzle = "svg-puzzle"
			}(f || (f = {}));
			const y = s.forwardRef((({
				animation: e,
				animatedSpeakerIconRef: t,
				area: a,
				autoFocus: n,
				children: f,
				disabled: S = !1,
				disabledStyle: b = "faded",
				draggable: C = !1,
				extraLineHeight: w,
				fakeActive: x,
				fakeHover: R,
				...
				const K = s.useRef(null),
					...
					te = s.useRef(null),
					{
						changePlaybackRate: ae,
						currentAnimations: ne,
						didFadeOutHighlights: re,
						sparklesCounter: se,
						transportAnimation: ie
					} = (0, v.C)(e, {
						containerRef: K,
						fillRef: j,
						flyingRef: $,
					...
					}),
					{
						...
						isDragging: ce,
						releasedAt: de
					} = (0, c.Z)(C && !S && !ne.includes("SHOW_USED"), {
						forceDragFrom: T,
						onDrag: A,
						onDragEnd: O,
						onDragStart: M
					...
					ue = ce && "word-bank" === a;
				ee.current = de;
				const me = !(!ne.includes("SHOW_USED") && !ue) || S,
					pe = ne.includes("SHOW_USED") || ue ? "used" : b;
				s.useImperativeHandle(q, (() => ({
					...
					get releasedAtRect() {
						...
						if (ee.current) {
							...
							if (t) return new DOMRect(ee.current.x, ee.current.y, t.width, t.height)
						}
					},
					setPlaybackRate: e => {
						ae(e)
				...
				return s.createElement(s.Fragment, null, s.createElement("span", {
					...
					useDisabledAttribute: !1,
					variant: "stroke",
					...(0, _._q)(`${W}-${k.V.ChallengeTapToken}`)
				}, (() => {
					const a = () => V ? s.createElement(l.Z, {
						...
						...(0, _._q)(k.V.ChallengeTapTokenText)
					}, W),
					...
					if (void 0 !== Y) return s.createElement(s.Fragment, null, s.createElement("span", {
						className: h.fill,
						ref: j
				...
				})())), ce || ie ? (0, i.createPortal)(s.createElement(y, {
					animation: ie,
					disabled: me && !ce,
			...
			const h = {
				...
				_ = ({
					...
					s.useEffect((() => {
						...
						!x || N.current && i.Xy(N.current, e) || x(T.current.filter(m.$K)), N.current = e
					}));
					const F = (0, g.Fx)(l.Rv),
						I = (0, g.Fx)(l.iH),
						D = (0, g.Fx)(v.hg),
						P = (0, g.Fx)(l.is),
						L = () => (0, v._G)(P.type) && (0, v.dN)(I, F, D),
						A = D && t.some((e => {
							var t;
							return null === (t = e.textTransliteration) || void 0 === t ? void 0 : t.tokens.some((e => (0, v.iZ)(e, D.type)))
						})),
						O = e => r()(c[`token-container-${b}`], {
							[c["with-transliteration"]]: A && L(),
							[c["has-hotkey"]]: e
						}),
						M = e => A && (e => {
							var a;
							return !D || (null === (a = t[e].textTransliteration) || void 0 === a ? void 0 : a.tokens.every((e => !(0, v.iZ)(e, D.type))))
						})(e) && L();
					switch (C) {
						case "lines":
							return s.createElement("div", {
								...
								className: r()(c[`input-line-${b}`], A && L() ? c["with-transliteration"] : null),
								key: e
							})))), s.createElement("div", {
								className: c["wrap-lines-tokens"]
							}, S.map(((e, r) => {
								const {
									attachToPrevToken: i = !1,
									offset: l,
									zIndex: c,
									...d
								} = w[e], u = f(b);
								return s.createElement(s.Fragment, {
									...
									key: e,
									style: {
										"--tap-tokens-token-margin-before": `${f(b, i)}px`,
									...
									onDragStart: t => null == E ? void 0 : E(e, t),
									onTap: () => y(e),
									ref: e => T.current[r] = e,
									size: b,
									text: t[e].text,
						...
						case "word-bank": {
							const i = t.findIndex(((e, t) => !S.includes(t)));
							return s.createElement("div", {
								className: r()(c["wrap-word-bank"], c[`wrap-word-bank-${b}`]),
								...(0, d._q)(u.V.WordBank)
							}, t.map(((r, l) => {
								const {
									attachToPrevToken: c,
								...
								return s.createElement("div", {
									...
									onDragStart: e => null == E ? void 0 : E(l, e),
									onTap: () => y(l),
									ref: e => T.current[l] = e,
									size: b,
									text: r.text,
		...
		4349: (e, t, a) => {
			...
			const r = {
				...
				s = ({
					...
					let i = s.slice(0, t);
					const o = s.slice(t);
					return e || (i = i.replace(/ /g, "·")), i ? n.createElement(n.Fragment, null, n.createElement("span", {
		...
		67208: (e, t, a) => {
			...
			const S = (0, _.ip)(),
				b = ({
					alwaysShowAnimation: e = !1,
					canStartAnimation: t = !0,
					dayOffset: a = 0,
					delay: _ = 0,
					daysInCurrentStreak: k,
					highlightNextDay: b,
					showFlamePop: w = !1,
					showSevenDayCalendar: x = !1,
					timezoneOffset: R,
					xpPerDay: T
				}) => {
					const N = (0, o.Z)(),
						F = "dark" === (0, r.Fg)(),
						I = k.length < y.Yt && !x ? y.Yt : S.length,
						D = (0, E.vN)((0, f.ji)(R) + a, S.length),
						P = (0, s.Z)(!1, (async () => (t || await (0, h.f)(), await (0, h._v)(_), !0)), [t]),
						L = C(T, k, I, D);
					return n.createElement("div", {
						className: v[`slide-circles-${I}`]
					}, L.map(((t, a) => {
						const r = a === k.length && b ? "streakNudge" === b ? "nudge" : "broken" : void 0,
						...
						return n.createElement("div", {
							...
							isPlaying: P && !N,
							mainSegment: [N || "streakNudge" === b ? 152 : w ? 60 : 30, 153],
							path: w ? F ? u : m : F ? p : g
				...
				C = (e, t, a, n) => {
					const r = (0, k.qj)(t).map(((a, r) => {
						const s = t.length - 1 - r;
						return {
							blue: a.streakFreezeUsed,
							label: S[(n - s + S.length) % S.length],
		...
		70752: (e, t, a) => {
			...
			const c = {
				...
				d = (0, o.p)(s.ZP.keys(c)),
				u = (e, t) => {
					if (t && (t = t.toLowerCase(), d(e)))
						for (const [a, n] of Object.entries(c[e])) t = t.replace(n, a);
					return t || ""
				},
				m = (0, o.p)(s.ZP.keys(i)),
				p = (e, t = !0) => {
					if (e) {
						...
						let s = "",
							i = 0;
						for (const t of r) i < t.start && (s += e.slice(i, t.start).replace(a, " ")), s += e.slice(t.start, t.end), i = t.end;
						i < e.length && (s += e.slice(i).replace(a, " ")), s = s.toLowerCase(), s = s.replace(/\s+/g, " "), s = s.trim(), e = s
					}
					return e || ""
				},
				g = {
			...
			class v {
				constructor(e, t) {
					this.isDone = !1, this.processRecognizerResult = e => {
						let t = "",
							a = "";
						...
						let n = `${t} ${a}`;
						n = ((e, t) => {
							if (t && ("en" === e && (t = (t = (t = (t = (t = t.replace(/'s/g, " is")).replace(/'m/g, " am")).replace(/'re/g, " are")).replace(/'ll/g, " will")).replace(/'ve/g, " have")), m(e)))
						...
						let s = !1;
						return r && this.rawTranscriptNorm !== r && (this.alignSolution(r), s = !0), this.rawTranscriptNorm = r, s
					}, this.getProgress = () => {
						...
						for (const e of this.solutionSequence) e.isRecognized || (a = !1);
						this.isDone = a
								...
								for (let a = 0; a < this.acceptSpanGroups.length; a++) {
									...
									for (const d of c)
										for (const c of d.texts) {
											...
											let p = (n = m, s = c, i = d.lenient, n && s ? i ? 1 - (0, r.sd)(s, n) / s.length : n === s ? 1 : 0 : 0);
											p -= .1 * Math.abs(m.length - c.length), p -= .1 * Math.abs(a - e), p > l && (l = p, o = d)
										}
								}
							a.push(o)
						}
						var n, s, i;
						return a
					}, this.learningLanguage = e.language, this.prompt = e.text, this.solutionSequence = t;
					const a = e => u(this.learningLanguage, p(e, !1));
					this.referenceNorm = a(this.prompt), this.rawTranscriptNorm = "", this.acceptSpanGroups = t.map((t => e.alternatives.filter((({
						start: e,
						end: a
					}) => a > t.start && e < t.end)).map((e => ({
						...e,
						texts: e.texts.map(a)
					})))))
				}
			...
			const h = class {
				constructor(e, t, a, n, r) {
					...
					this.recognizer = (() => {
						...
						return e.continuous = !0, e.interimResults = !0, e
					})(), this.start = () => {
						this.recognizer.start()
					}, this.stop = () => {
						window.clearTimeout(this.recordingTimer), this.recognizer.abort(), this.updateRecognizerResults(this.duoRecognizerProcessor.solutionSequence, !0), this.onEnd()
					}, this.destroy = () => {
						window.clearTimeout(this.recordingTimer), this.recognizer.abort(), this.onEnd()
					}, this.onResult = e => {
						if (window.clearTimeout(this.recordingTimer), this.duoRecognizerProcessor.processRecognizerResult(e) && this.updateRecognizerResults(this.duoRecognizerProcessor.solutionSequence, this.duoRecognizerProcessor.isDone), this.duoRecognizerProcessor.isDone) this.onEnd(), this.recognizer.abort();
						else {
					...
					}, this.recognizer.lang = null !== (s = g[a.language]) && void 0 !== s ? s : a.language, this.recognizer.onresult = this.onResult, this.recognizer.onerror = this.onError, this.duoRecognizerProcessor = new v(a, n), this.onEnd = t, this.updateRecognizerResults = e, this.updateRecognizerResults([{
						end: 0,
						isRecognized: !1,
						start: 0,
						text: ""
					}], !1), this.handleError = r
				}
			},
				f = (e, t, a, r, s) => {
					const i = {
						...
						k = () => {
							const n = {
							...
							},
								{
									...
									const {
										text: a
									} = e, n = t.filter((e => void 0 !== e.hintTable));
									let r = 0,
										s = 0;
									const i = n.map((e => {
										const t = a.indexOf(e.value, r),
											n = a.slice(r, t),
											i = s + (0, l.RF)(n);
										return s = i + (0, l.RF)(e.value), r = t + e.value.length, {
											end: s,
											isRecognized: !1,
											start: i,
											text: e.value
					...
					return n.useEffect((() => (_.current = k(), () => {
						...
						resetRecognizer: () => {
							var e;
							u(!1), null === (e = _.current) || void 0 === e || e.stop(), _.current = k()
						},
						startRecognizing: () => {
							var e;
							u(!0), null === (e = _.current) || void 0 === e || e.start()
						},
						stopRecognizing: (e = !1) => {
							var t, a;
							u(!1), e ? null === (t = _.current) || void 0 === t || t.destroy() : null === (a = _.current) || void 0 === a || a.stop()
						}
					}
				}
		},
		...
		42269: (e, t, a) => {
			...
			const i = () => {
				const e = (0, s.tX)(),
					t = (0, s.Fx)((e => e.sessionEnd.slides));
				n.useEffect((() => {
					const a = t.filter((e => "can-track" === e.status));
					a.forEach((e => (0, r.l)(e))), a.length && e({
		...
		66530: (e, t, a) => {
			...
			const c = ({
				...
				const [p, g] = n.useState(), [v, h] = n.useState(!1), [f, _] = n.useState([]), [k, E] = n.useState(""), [y, S] = n.useState(-1), [b, C] = n.useState(0), [w, x] = n.useState(""), R = n.useRef(), T = n.useRef(), N = n.useRef(), F = n.useMemo((() => m.filter((({ }, e) => !u.includes(e))).sort(((e, t) => t.localeCompare(e)))), [u, m]), I = n.useMemo((() => {
					if ((0, s.y)(t) && p) return (0, s.M)(t)(F, {
				...
				return n.useEffect((() => {
					...
					void 0 !== N.current && r.Xy(N.current, u) || (E(""), v ? h(!1) : x(""), _(r.DZ(m.length, (e => {
						var t;
						return (null === (t = N.current) || void 0 === t ? void 0 : t.includes(e)) && !u.includes(e) ? void 0 : f[e]
					}))), N.current = u)
				})), n.useEffect((() => {
					if (!I || "disabled" === a) return;
					const t = t => {
						if ((0, o.b)(t, "debug") || (0, o.b)(t, "slowTts") || (0, o.b)(t, "tts")) return;
						let n = !1;
						const r = () => {
							if ("remove-only" !== a && 1 === t.key.length) {
								const a = `${k}${t.key}`;
								w ? window.performance.now() < b + e && I.match(a, [w]).partialMatches > 0 ? (E(a), C(window.performance.now())) : (E(I.match(t.key).partialMatches > 0 ? t.key : ""), x("")) : I.match(a).partialMatches > 0 && E(a), n = !0
							}
						};
						switch (t.key) {
							case " ":
							case "Enter":
								...
								break;
							case "Backspace":
								k && !w ? E(k.slice(0, -1)) : null == c || c(), n = !0;
								break;
							default:
								r()
						}
					...
					if (R.current = k, T.current = w, !e || !I) return;
					const {
						highlights: t,
						match: n
					} = w ? {
					...
					if (_(m.map(((e, a) => u.includes(a) ? f[a] : t[F.indexOf(e)]))), n > -1) {
						const e = m.findIndex(((e, t) => e === F[n] && !u.includes(t)));
						S(e), "unique" === a ? (E(""), h(!0), x(m[e].slice(t[n].index)), C(window.performance.now()), d(e)) : "complete" === a && t[n].index === m[e].length && d(e)
					} else S(-1)
				})), {
					highlights: f
				}
		...
		71184: (e, t, a) => {
			...
			const p = e => async (t, a) => {
				...
				const y = (0, s.d)(a()),
					S = (0, r.q0)(a()),
					b = Math.max(0, S.hearts - 1);
				if ("session_mid" === e) {
					const e = (0, n.lA)(a()),
						t = e.challengeStates[e.currentIndex],
						r = (0, d.TD)(e);
					if (t.type === m.Sm.CharacterWrite && (null === (p = t.guess) || void 0 === p ? void 0 : p.numSkippedStrokes) && (null === (g = t.guess) || void 0 === g ? void 0 : g.numSkippedStrokes) > 0) return;
					(0, u.track)("health_lost", {
					...
					(0, u.track)("health_lost", {
						...
						health_empty_skill: null === (E = e.levelData) || void 0 === E ? void 0 : E.level.id,
						health_total: b,
						type: "story"
					}), 0 === b && (0, u.track)("health_empty", {
				...
				if (!(0, l.is)(a().heartsState)) {
					if (y) {
						const e = await (0, c.b)();
						await e.add("submittableRequests", {
							type: "remove-heart"
						})
					} else o.Vi.removeHeart();
					t({
		...
		83735: (e, t, a) => {
			...
			const xe = (e, t) => async () => {
				var a;
				if (await (0, I._v)(ie.UV), (null === (a = (0, k.is)(e())) || void 0 === a ? void 0 : a.id) !== t) throw new G.$K
			}, Re = () => async (e, t) => {
				const a = (0, k.Oz)(t()),
					n = (0, k.lA)(t()),
					r = (0, k.is)(t()),
				...
				switch (n) {
					...
					case void 0:
						...
						if (s) se.Z.start("session_end_grade"), e({
				...
				try {
					...
					(0, ee.vU)("Client-side grading failed", {
						ex: e
					}), (0, F.Hx)(e) && (0, ke.trackAndLogApiError)("grading_failed", "All grading methods failed", e), _ = {
						correct: !0,
						guess: ""
					}
				} (0, Z.gQ)("gradeCorrect") && (_.correct = !0), (0, D.Ap)(), a({
					gradingResult: _,
					skipped: e,
					timeTaken: g.startTime ? t - g.startTime : void 0,
					type: "UPDATE_GRADED_CHALLENGE"
				}), !u || _.correct || e || (0, f.P)(v) && (null !== (r = v.mathRetryCount) && void 0 !== r ? r : 0) > 0 || ((e, t, a) => {
					var n, r, s;
					switch (t.type) {
						case ye.Sm.ListenSpeak:
						case ye.Sm.Speak:
							(null !== (n = a.numRetriesLeft) && void 0 !== n ? n : P.Tu) <= 1 && e((0, o.$)("session_mid"));
							break;
						case ye.Sm.ChessStar:
						case ye.Sm.ChessNormal:
						case ye.Sm.ChessFictionalBoard: {
							const t = a.guess;
							"incorrect" === (null === (r = null == t ? void 0 : t.gradingState) || void 0 === r ? void 0 : r.type) && t.gradingState.isFirstMistake && e((0, o.$)("session_mid"));
							break
						}
						case ye.Sm.MathChallengeBlob: {
							const n = (0, be.Sd)(t.challengeBlob),
								r = a.multiStepStepIndex,
								i = n && (0, be.IQ)(a.guess) && void 0 !== r && 1 === (null !== (s = a.guess.stepMistakeCounts[r]) && void 0 !== s ? s : 0);
							n && !i || e((0, o.$)("session_mid"));
							break
						}
						case ye.Sm.WriteComprehension:
							break;
						default:
							e((0, o.$)("session_mid"))
					}
				})(a, g, _), l = (0, k.is)(n());
				const E = l.challenges[i.currentIndex],
					y = (0, O.S6)(n());
				...
				y && a({
					...
					skills: c,
					user: d
				}), !0 === _.multiStepIsDialogue || e && v.hasBrokenTts || Fe(_.correct), (0, A.w)(l, d, i, _, e, E.timeTaken, h), _.correct || g.type !== ye.Sm.MathChallengeBlob || (i.challengeAttemptCounts[g.id] || 0) >= 2 && (0, ke.track)("math_challenge_exceed_retry", {
					challenge_id: g.id,
					skill_id: l.skillId
				}), (0, R.h)(n()) && (a({
					hasXpBoost: p,
					...
					type: "END_SESSION",
					user: d
				}), l = (0, k.is)(n()), i.sessionParams.isFinalLevel && l.failed ? a({
					nativeAd: void 0,
					slideData: [{
				...
				if (r.type === ye.FF.Placement && !(null == p ? void 0 : p.placementTestAvailable)) throw new G.w(`Trying to start a ${r.type} session without placementTestAvailable`);
				[ye.FF.Lesson, ye.FF.LexemePractice, ye.FF.LexemeSkillLevelPractice, ye.FF.SpacedRepetition].includes(r.type) && c({
					type: "ENABLE_BONUS_POINTS"
				});
				const {
					challengeIdSections: g,
					challenges: v
				} = s.type === ye.FF.SpecifiedMatchPractice ? (0, me.Z6)(r.challenges, m) : {
					challengeIdSections: (0, me.oT)(r.challenges, s.isFinalLevel ? 2 : 1),
					challenges: r.challenges
				};
				if (r.challenges = v, "math" === (null == p ? void 0 : p.subject) && a) {
					const e = (0, b.MK)(d());
					e && c({
						sectionId: e.id,
				...
				const h = e => e.map((e => {
					try {
						...
						if (t instanceof G.u4) return (0, ke.track)("math_parsing_failure", {
							challenge_id: e.id,
							error: t.message
						}), null;
						throw t
				...
				r.adaptiveChallenges && (r.adaptiveChallenges = h(r.adaptiveChallenges)), (null === (u = r.adaptiveInterleavedChallenges) || void 0 === u ? void 0 : u.challenges) && (r.adaptiveInterleavedChallenges.challenges = h(r.adaptiveInterleavedChallenges.challenges)), r.challenges = h(r.challenges), c({
					challengeIdSections: g,
					chessPlayerColor: e,
					chessPvpInitialState: t,
					hasUserHearts: (0, y.MQ)(d()),
					isDesktop: (0, k.$4)(d()),
					levelData: a,
					session: r,
					sessionParams: s,
				...
				const {
					...
					user: l
				} = t(), c = (0, N.mu)(t(), Date.now());
				if (!o) {
					if (i.isFinalLevel && r) return e({
					...
					e({
						...
						courseId: (0, k.Oz)(t()).id,
						isZombieMode: (0, S.d)(t()),
						levelId: null == n ? void 0 : n.level.id,
						session: s,
						sessionParams: i,
						type: "QUIT_SESSION"
					}), (0, ie.vx)({
						hasXpBoost: (0, N.mu)(t(), Date.now()),
						isFirstSessionInCourse: (0, k.Oz)(t()).placementTestAvailable,
						path: (0, b.HF)(t()),
						pathSectioned: (0, b.DN)(t()),
						player: a,
						subject: (0, k.Oz)(t()).subject,
						transliterationSetting: (0, Ee.hg)(t())
					})
				}
				return {
				...
				try {
					await e((async (e, t) => {
						...
						const D = (0, k.Mb)(t()),
							...
							be = (0, k.np)(t()),
							xe = (0, re.Bm)(P.path),
							Re = (0, _e.G)(se, (0, ie.GR)(V), null === (a = V.levelData) || void 0 === a ? void 0 : a.level, A, P.id, (0, ie.Xe)(V));
						let Te, Ne, Fe;
						const Ie = (0, ie.Ks)(t()),
							De = () => {
								var e;
								return (null === (e = (0, k.is)(t())) || void 0 === e ? void 0 : e.id) !== se.id
							},
							Pe = () => {
								if (De()) throw new G.$K
							},
							Le = () => {
								if ((0, k.Oz)(t()).id !== P.id) throw new G.Di
							};
						if (e({
							...
							if (await e.add("submittableRequests", {
								...
								const e = (0, ne.mI)(Re, V.levelData, be),
									[t, a] = (0, te._u)(Re.type, V.levelData, P.path, P.pathSectioned, null !== (o = null == ee ? void 0 : ee.index) && void 0 !== o ? o : 0),
									n = (0, te.g2)(Re, V.levelData, Ee);
								let r = (0, q.t8)(P, "path", t);
								r = (0, q.t8)(r, "pathSectioned", a), r = (0, q.t8)(r, "placementTestAvailable", !1), r = (0, q.t8)(r, "xp", r.xp + e.xp);
								const s = {
									...r,
								...
								Fe = (0, ae.m3)(e, be), Te = {
									...
									currentCourse: s,
									health: O,
									rewardBundles: be.rewardBundles,
									streakData: Fe.streakData,
									xpGains: be.xpGains ? be.xpGains.concat([e]) : [e]
								}
							}
						} else {
							await p.SL;
							try {
								(0, ke.track)("session_end_attempt", {});
								const e = new AbortController;
								Te = await F.Vi.sessionSubmit(Re, {
									onError: t => {
										(0, ke.trackAndLogApiError)("submit_session_failed", "Failed to submit session", t), De() && e.abort()
									},
									signal: e.signal
								}), (0, ke.track)("session_end", {
									...Ie,
									...Te.trackingProperties,
									upload_timestamp: Date.now()
								}), V.welcomeForkSelection && V.onboardingVia && (0, ke.trackAddCourseComplete)(P.fromLanguage, P.subject, V.welcomeForkSelection, V.onboardingVia), Ne = await F.Vi.userInfoPartial((0, Ce.Jb)(), ["courses", "currentCourse", "health", "rewardBundles", "streakData{currentStreak,longestStreak,previousStreak}", "xpGains"])
							} catch (e) {
								throw (0, ie.gZ)(e, (0, me.Xd)(Re.type)), e
							}
							Pe(), Le()
						} (0, j._B)({
							courseId: P.id,
						...
						const Ae = (0, we.ab)(be.timezoneOffset, be.xpGains),
							Oe = Te.xpGain > 0 && 0 === Ae,
							Me = null !== (x = null === (w = be.streakData.currentStreak) || void 0 === w ? void 0 : w.length) && void 0 !== x ? x : 0;
						if (Oe) {
							const t = (0, M.Ux)();
							e({
								streakExtension: {
						...
						if (Math.random() < (0, Q.O)("send_goals_progress", 0, D)) {
							const t = Oe && 0 === Me,
								a = (0, X.Oj)(Re, {
									streakExtended: Oe,
									streakStarted: t,
							...
							} else F.JV.sendBatchUpdate(be.id, a, (0, M.Ux)(), be.timezone).catch((e => (0, ke.trackAndLogApiError)("update_goals_progress_failed", "Failed to update goals progress", e)));
							const n = {
							...
							e((0, X.B_)(n)), e((0, i.mE)(n))
						}
						if (void 0 !== L && (0, ve.SZ)(L)) {
						...
						if (!U) {
							let a = null === (R = be.mistakeCountInfo) || void 0 === R ? void 0 : R.mistakeCount;
							void 0 !== a && (a += (0, me.VC)(Re));
							const {
								includeListening: r,
								includeSpeaking: s
							} = (0, n.eG)(t());
						...
						if ((0, oe.rK)(Re.type) && (0, oe.gv)(Ze) && e({
							courseId: P.id,
							sessionName: (0, oe.tL)(Re.type),
							type: "COMPLETE_PRACTICE_HUB_SESSION"
						}), Re.type === ye.FF.SpecifiedMatchPractice && e({
							...
							const a = [e(l.Hm(D.ipCountry, (0, le.Ay)(be.plusDiscounts, Date.now()), !1)), e(r._()), e((0, h.DG)()), e((0, u.CQ)({
								target: "linkedin"
							})), e((0, d.W)({
								courseId: P.id
							}))];
							...
							})()), Oe && (Me + 1) % fe.mx == 0 && a.push(e((0, h.J0)())), await Promise.all(a), Pe(), Le()
						}
						const ze = (0, k.Oz)(t()),
							Ue = (0, E.oV)(t()),
							Ge = (0, k.Al)(t()),
							...
							Xe = (0, y.q0)(t()),
							Ve = (0, re.Bm)(ze.path),
							Qe = V.levelData ? (0, re.m8)(ze.path, (e => {
								var t;
								return e.id === (null === (t = V.levelData) || void 0 === t ? void 0 : t.level.id)
							}), V.levelData) : Ve;
						V.levelData && (0, re.Nc)(P.path, ze.path, V.levelData) && e({
							name: "pathSkipping",
							type: "CREATE_HOME_MESSAGE"
						}), (0, j.G9)(Te.xpGain)({
							dispatch: e
						});
						const Ye = (0, X.VR)(Ue, We),
							qe = (0, E.Ap)(t());
						e((0, ce.kl)({
							availableQuests: Ye,
							goals: Be,
							...
							user: We
						})), Re.type !== ye.FF.AlphabetLesson && Re.type !== ye.FF.AlphabetPractice || U || e(s.fh(!0)), U || void 0 === He.inventory.society_streak_freeze_refill || (e({
							maxQuantity: fe.TK,
							type: "REFILL_SOCIETY_STREAK_FREEZES"
						}), F.Vi.useUserShopItem("society_streak_freeze_refill")), se.type === ye.FF.GlobalPractice && Xe.hearts > O.hearts && (0, ke.track)("health_refill", {
						...
						let et = (0, z.XN)({
							...
							levelData: Qe,
							monthlyChallengeThreshold: (0, E.Ap)(je),
							path: ze.path,
							player: (0, k.lA)(je),
							rewardedHearts: void 0 === Ne ? 0 : Ne.health.hearts - O.hearts,
							scoreSessionEndVariant: Je,
							sectionType: null === (I = (0, b.MK)(je)) || void 0 === I ? void 0 : I.type,
							showScoreLinkedinSyncOnSessionEnd: (0, de.aZ)(Je) && (0, ue.QW)(Je, je),
							streakGoalData: Ke.get(he.vk).value,
							streakGoalOptions: Ke.get(he.vB).value,
							streakNudgeState: (0, k.cQ)(je).streakNudgeShown,
							streakSocietyProgressState: (0, k.cQ)(je).streakSocietyProgressShown,
							student: (0, T.Bs)(je),
							subject: ze.subject,
							unlockedAchievementsV3: _.XX(je),
							user: (0, k.np)(je)
						});
						if (!se.failed && se.type === ye.FF.SectionTest) {
							const {
								sectionIndex: t
							} = se;
							e({
						...
						const tt = !se.failed && se.type === ye.FF.SectionTest,
							at = !se.failed && ze.pathSectioned.length > 0 && se.type === ye.FF.UnitReview && 1 === (null == Ve ? void 0 : Ve.unitNumber);
						(tt || at) && e({
							shouldReturnToSections: !0,
							type: "SET_SHOULD_RETURN_TO_SECTIONS"
						}), (0, Z.gQ)("debugSlides") || (et = await (0, pe.r)(et, {
							isZombieMode: U,
							useOnboardingBackend: !0 === (0, Q.O)("web_use_onboarding_backend", void 0, D)
						}), Pe(), Le()), await (0, de.ZS)({
							activeLevel: xe,
							freshActiveLevel: Ve,
							freshCourse: ze,
						...
						const nt = (0, z.JW)(et, V),
							rt = (0, z.I)(nt);
						if (!(0, Z.gQ)("debugSlides") && rt.some((e => "streakSocietyWelcomeChest" === e.type)) && e((0, v.K)(We.learningLanguage)), (0, Z.gQ)("debugSlides") || Re.type !== ye.FF.LevelReview && (Re.type !== ye.FF.LexemePractice || "practice_level_review" !== V.sessionParams.lexemePracticeType) || U || e((0, ce.GH)({
							receivingBoost: (0, E.D_)(t()).pendingRewards.some((({
								reward: e
							}) => (0, ce.be)(e))),
							user: We
						})), void 0 !== Ge && (0, ve.SZ)(Ge) ? e({
						...
						const st = (0, E.ey)(je);
						!U && (null == st ? void 0 : st.status) !== Se.S.ACTIVE && (0, W.JD)(Date.now()) && e((0, i.pt)()), !U && (0, ve.zg)(He) && (0, ve.E6)(Ge) && e((0, g.z)())
					}))
				} catch (t) {
					e({
						error: t,
				...
				const a = (0, k.MY)(t());
				a && (0, ke.track)("challenge_difficulty_click", {
				...
				const a = (0, k.jv)(t()),
					n = (0, k.MY)(t()),
					r = (0, k.is)(t());
				n && (0, ke.track)("challenge_difficulty_click", {
					challenge_type: n.type
				}), (0, ke.track)("toggle_tap", {
				...
				}), Math.random() < .001 && (0, ke.track)("type_to_select_token", {
					challenge_type: e,
					sampling_rate: .001
				})
			}, Ze = () => async (e, t) => {
				var a, n, r, s, i, o;
				const l = null === (n = null === (a = (0, k.MY)(t())) || void 0 === a ? void 0 : a.gradingResult) || void 0 === n ? void 0 : n.numRetriesLeft,
					c = null === (r = (0, k.lA)(t())) || void 0 === r ? void 0 : r.currentIndex;
				await (0, I._v)(3e3);
				const d = (0, k.lA)(t()).status,
					u = null === (i = null === (s = (0, k.MY)(t())) || void 0 === s ? void 0 : s.gradingResult) || void 0 === i ? void 0 : i.numRetriesLeft,
					m = null === (o = (0, k.lA)(t())) || void 0 === o ? void 0 : o.currentIndex;
		...
		66369: (e, t, a) => {
			...
			const c = () => (e, t) => {
				...
				const a = (0, n.d)(t()),
					...
					u = c ? [c, ...d] : d;
				if (u.filter((e => "can-track" === e.status)).forEach((e => (0, o.l)(e))), !a) try {
					r.zi.ackSessionEndMessages(u.flatMap((e => (0, i.Jp)(e.slide.type) ? [] : [{
						ctaWasClicked: "cta" === e.action,
						messageId: e.slide.type,
						timestamp: (0, s.Gz)(e.time[0][0])
					}])))
				} catch (e) {
					(0, l.trackAndLogApiError)("ack_messages_failed", "Failed to acknowledge session end messages", e)
				} (0, l.track)("session_end_screens_show", {
		...
		77873: (e, t, a) => {
			...
			var n = a(83735),
				...
				l = a(79465);
			const c = e => (t, a) => {
				const s = (0, r.lA)(a()).smartTipToShow;
				if (void 0 === s) throw Error("Cannot grade undefined Smart Tip.");
				if (void 0 === s.startTime) throw Error("Smart Tip should have a start time when grading.");
				const i = (0, o.P9)(s) === s.guess;
				(0, l.track)("smart_tip_challenge_answered", {
				...
				d = ({
					...
					var m;
					if (!(0, o.RZ)(c.type, l.sessionParams)) return;
					let p = (0, o.C8)(n, e, t, r, l, d, u);
					if (!p && (0, i.gQ)("smartTip"))
						for (const e of null !== (m = t.smartTips) && void 0 !== m ? m : []) {
							const t = (0, o.vT)(e.url);
							if (t) {
								p = {
									...t,
									trigger: {
		...
		94944: (e, t, a) => {
			...
			var n = a(86518),
				...
				l = a(97106);
			const c = e => async (t, a) => {
				await (0, i.OC)((0, r.__)(a()), "Streak Society Boost");
				try {
					...
					(0, o.trackAndLogApiError)("purchase_user_shop_item_failed", `Failed to purchase xp boost item ${l.zL.ITEM_NAME_30_MIN} while awarding streak society xp boost`, e)
				}
				await t((0, n.J0)())
			}
		},
		...
		86233: (e, t, a) => {
			...
			const l = e => e.stories,
				...
				v = (n.P1(l, (e => -1 !== e.speakingDisabledLineIndex)), n.P1(l, (e => {
					var t;
				...
				_ = n.P1(l, (e => (0, s.C7)(e.storyElements))),
				k = n.P1(l, (e => {
					var t, a;
					...
					return n && r ? (0, o.lo)(r, n.elementIndex, s) : 0
				})),
				E = n.P1(l, (e => {
					var t;
					return e.storyElements && (null === (t = e.storySession) || void 0 === t ? void 0 : t.furthestPosition) && (0, o.O$)(e.storyElements, e.storySession.furthestPosition.elementIndex)
				})),
				y = n.P1(E, l, ((e, t) => {
					var a;
					return e ? null === (a = null == t ? void 0 : t.storyElements) || void 0 === a ? void 0 : a[e] : void 0
				})),
				S = n.P1(g, (e => null == e ? void 0 : e.pendingStoryEndSections)),
				b = n.P1((e => e.stories.storyElements), (e => {
					var t;
					...
					if (c) return !0;
					if (i) return !1;
					if ("completed" === r) return !1;
					if ("story-end" === r) return !0;
					if (void 0 === t || void 0 === e || void 0 === a) return !1;
					if ("tap-translation-hint" === l) return !1;
					if (null == n ? void 0 : n.completed) return !0;
					if ("type-text" === (null == n ? void 0 : n.type) && !n.completed && n.answer.length > 0) return !0;
					if ("freeform-writing" === (null == n ? void 0 : n.type) && !n.completed && n.fetchedCorrection) return !0;
					if ("beats" === (null == n ? void 0 : n.type) && !n.completed) return !0;
					if (n && !n.completed) return !1;
					const u = e[t.elementIndex],
						m = null === (d = (0, s.z_)(u)) || void 0 === d ? void 0 : d.text.length;
					if ("DUO_POPUP" === u.type) return !0;
					const p = !!(void 0 === m || void 0 !== t.textIndex && t.textIndex >= m - 1),
						g = e[t.elementIndex + 1],
						v = !(0, s.z$)(g) && "CHALLENGE_PROMPT" !== u.type,
						h = (0, o.lo)(e, t.elementIndex, !0),
						f = e[h],
					...
					return (0, o.Nh)(a, k) || p && v
				})),
				C = n.P1((e => {
					var t;
					return null === (t = e.stories.storySession) || void 0 === t ? void 0 : t.challengeSession
				}), (e => "freeform-writing" === (null == e ? void 0 : e.type) && !e.completed && (0, i.Bv)(e))),
				w = n.P1(g, (e => {
					var t;
		...
		8096: (e, t, a) => {
			...
			const Q = ({
				...
				Y = ({
					...
					const l = !(n && i),
						...
						g = a ? e === p.Il.YELLOW ? null : s.createElement(c.Z, {
							...
							src: e === p.Il.GREEN ? m ? E : y : e === p.Il.RED ? m ? S : b : m ? C : w
						})),
						v = a && e === p.Il.YELLOW ? F["content-full-width"] : F.content;
					return s.createElement("div", {
						className: F.wrap,
						...(0, I._q)(A.V.Blame, t ? A.V.BlameCorrect : A.V.BlameIncorrect)
				...
				q = ({
					...
					const {
						gradingResult: c,
						solutionTranslation: d
					} = e, u = (0, O.LN)(e), m = (0, O.zn)(e), p = (0, f.Fx)(k.lA), g = (0, f.Fx)(W.hg), v = null === (l = (0, f.Fx)(k.is).showBestTranslationInGradingRibbon) || void 0 === l || l;
					if (!c) throw Error("Cannot construct blame ribbon text for ungraded challenge.");
					s.useEffect((() => {
						u.some((e => !e)) && (0, G.Kp)("Correct solutions returned invalid data for a standard challenge", {
							data: {
								challenge: e,
					...
					const E = z((() => {
						...
						if (!(0, L.lw)(n)) {
							return (null !== (t = de({
								...
								subtitle: void 0,
								subtitleFormat: "text",
								title: a ? (0, h._i)((0, D.ub)()) : (0, h._i)(21270)
							}
						}
						const {
							fromLanguage: p,
						...
						y = z((() => (0, h._i)((0, D.ul)(!c.blameType && a))), [e, a]),
						{
							subtitle: S,
							subtitleLang: b,
							subtitleFormat: C,
						...
						x = !!c.blameType || !a,
						R = (0, L.lw)(n) || (0, L.$l)(n) ? s.createElement(_, {
							color: t,
							onReportClick: r,
							reported: i
						}) : null,
					...
					if (!a && o) {
						const e = s.createElement(Q, {
							...
							}, (0, h._i)(23926)), s.createElement("span", null, S)),
							subtitleLang: b,
							title: (0, h._i)(16634)
						});
					...
					if ((0, L.lw)(n) && d && v) {
						const {
							...
							fromLanguage: r,
							learningLanguage: i
						}), l = void 0 === o ? void 0 : o === r ? i : r, c = s.createElement(Q, {
							color: t,
							subtitle: a ? `${(0, h.H8)(15039)} ${e.solutionTranslation}` : e.solutionTranslation,
							subtitleLang: l,
							title: y
						});
						return s.createElement(Y, {
				...
				j = ({
					...
					mainContent: s.createElement(Q, {
						color: e,
						subtitle: 1 === a ? (0, h._i)(13747) : (0, h._i)(5563),
						title: 1 === a ? (0, h._i)(20665) : (0, h._i)(5510)
					}),
				...
				$ = ({
					...
					var i;
					if (!e.gradingResult) throw Error("Cannot construct math blame ribbon text for ungraded challenge.");
					const {
						gradingResult: o
					} = e, {
						subtitle: l,
						...
						gradingResult: o
							...
							}, d = (0, Z.Z)((() => a ? (0, h._i)((0, D.ub)()) : (0, h._i)(29711)), [a]);
					return s.createElement(Y, {
						color: t,
						correct: a,
						isMath: !0,
				...
				ne = ({
					...
					var o, l;
					if (!(0, L.lw)(n)) throw Error("Non-language course not supported for Listen Speak blame (yet)");
					const c = le({
						...
						p = (0, f.Fx)(k.lA),
						g = (0, f.Fx)(W.hg),
						v = null === (o = (0, f.Fx)(k.is).showBestTranslationInGradingRibbon) || void 0 === o || o,
						E = (0, O.LN)(e);
					s.useEffect((() => {
						E.some((e => !e)) && (0, G.Kp)("Correct solutions returned invalid data for a Listen Speak challenge", {
							data: {
								challenge: e,
								mistakesReplacementChallengeIndex: p.mistakesReplacementChallengeIndex,
								session: p.session,
					...
					if ((0, B.bc)().includes(e.type) && !a) {
						...
						return s.createElement(Y, {
							...
							mainContent: s.createElement(Q, {
								color: t,
								subtitle: v ? `${(0, h.H8)(15039)} ${e.solutionTranslation}` : null,
								subtitleLang: n,
								title: (0, h._i)(6840)
							}),
							reportButtons: x
					...
					if (e.type === X.Sm.Listen) {
						const {
							closestSolution: n
						} = null !== (l = e.gradingResult) && void 0 !== l ? l : {}, r = n ? (0, H.Dg)(n) : void 0, {
							prompt: i
						} = e, o = (0, H.Dg)(i);
						if (a && r !== o) return s.createElement(Y, {
							color: t,
							correct: a,
							mainContent: s.createElement(Q, {
								color: t,
				...
				re = ({
					...
					const o = s.createElement(_, {
						...
						c = (0, Z.Z)((() => a ? (0, h._i)(i.UP(l)) : (0, h._i)(42581)), [a]),
				...
				se = ({
					...
					const r = s.createElement(_, {
						...
						l = (0, Z.Z)((() => t ? (0, h._i)(i.UP(o)) : (0, h._i)(6840)), [t]);
					return s.createElement(Y, {
						color: e,
						correct: t,
						mainContent: s.createElement(Q, {
				...
				ie = ({
					...
					const r = (0, Z.Z)((() => t ? (0, h._i)((0, D.ub)()) : (0, h._i)(23926)), [t]);
					return s.createElement(Y, {
						color: e,
						correct: t,
						mainContent: s.createElement(Q, {
				...
				ce = ({
					...
					const {
						blameSubtext: t,
						blameSubtextFormat: a,
						correct: n
					} = e;
					if ("latex" === a) return {
						subtitle: n ? void 0 : t,
						subtitleFormat: a,
						title: n ? (0, h._i)((0, D.ub)()) : (0, h._i)(21270)
					}
				},
				de = ({
					challenge: e,
					...
					if (!("chessPuzzleInfo" in e)) return;
				...
				ue = ({
					...
					if ("completed" !== n.status) return;
					const r = e.type === X.Sm.ChessPvpMatch;
					switch (n.outcome) {
						case "win":
							return {
								subtitle: void 0, subtitleFormat: "text", title: me(n.endCondition, r)
							};
						case "loss":
							return {
								subtitle: void 0, subtitleFormat: "text", title: pe(n.endCondition, r)
							};
						case "draw":
							return {
								subtitle: void 0, subtitleFormat: "text", title: ge(n.endCondition, r)
							};
						default:
							throw (0, M.RJ)(n.outcome), Error(`Unexpected match state outcome: ${n.outcome}`)
					}
				},
				me = (e, t) => {
					if (!t) return (0, h._i)(66086);
					switch (e) {
						case "resignation":
							return (0, h._i)(67229);
						case "abandoned":
				...
				pe = (e, t) => {
					switch (e) {
						...
						case "timeout":
							return (0, h._i)(68330);
						case "disconnection":
							return t ? (0, h._i)(69444) : (0, h._i)(66085);
						default:
							return t ? (0, h._i)(66086) : (0, h._i)(66085)
					}
				},
				ge = (e, t) => {
					switch (e) {
						case "stalemate":
							return (0, h._i)(66083);
						case "abandoned":
							return t ? (0, h._i)(69095) : (0, h._i)(66084);
						default:
							return (0, h._i)(66084)
					}
				},
				...
				fe = ({
					...
					learningLanguage: r,
					solutionLang: i,
					transliterationSetting: o
				}) => {
					const {
						correct: c
					} = n, d = (() => {
						if (!c) return t && (0, W.dN)(r, a, o, !0) ? s.createElement(l.Z, {
							highlightStyle: "normal",
							state: "active",
							text: [...e[0]],
							transliteration: t
					...
					return {
						...
						title: c ? (0, h._i)((0, D.ub)()) : e.length > 1 ? (0, h._i)(8766) : (0, h._i)(23926)
					}
				},
				_e = ({
					defaultCorrectSolutions: e,
					...
					if (null == r ? void 0 : r.length) return {
						...
						subtitleLang: a,
						title: n ? (0, h._i)(4081) : (0, h._i)(23926)
					}
				},
				ke = ({
					defaultCorrectSolutions: e,
		...
		9129: (e, t, a) => {
			...
			a(74541),
				function (e) {
					e[e.None = 0] = "None", e[e.Super = 1] = "Super", e[e.Max = 2] = "Max"
				}(k || (k = {}));
			const E = (e, t) => ({
				animation: e,
				...
				R = {
					...
					[i.w.BigRightStreak]: {
						...
						rawTemplates: [{
							...
							message: () => (0, l.H8)(20295, {
								challenges: 10
							}),
							trackingIndex: 10
						}, {
							message: () => (0, l.H8)(20893, {
								num_right: 10
							}),
							trackingIndex: 1
						}, {
						...
						test: ({
							player: e
						}) => 10 === e.coachDuo.currentCorrectStreak
					},
					[i.w.BigRightStreakCheckpointTest]: {
						...
						test: ({
							player: e
						}) => 8 === e.coachDuo.currentCorrectStreak
					},
					[i.w.CapstoneHardExercises]: {
						...
						test: ({
							player: e
						}) => !!(e.session.type === p.FF.LevelReview || e.session.type === p.FF.LexemePractice && e.levelData && (0, d.$)(e.levelData.level)) && (e.status === o.c.CapstoneReviewSplash ? -1 : e.currentIndex) === e.session.challenges.findIndex((e => e.indicatorType === p.A.HardChallenge)) - 1
					},
					[i.w.MistakesReview]: {
						rawTemplates: [{
							message: e => (0, l.H8)(11949, {
								number_1: e.player.session.challenges.filter((e => e.indicatorType === p.A.PastMistake)).length
							})
						}],
						test: ({
							player: e
						}) => !!(e.session.type === p.FF.GlobalPractice || e.session.type === p.FF.Lesson || e.session.type === p.FF.LevelReview || e.session.type === p.FF.LexemePractice && void 0 !== e.levelData && (0, d.$)(e.levelData.level) || e.session.type === p.FF.LexemeSkillLevelPractice || e.session.type === p.FF.SpacedRepetition) && (e.status === o.c.CapstoneReviewSplash ? -1 : e.currentIndex) === e.session.challenges.findIndex((e => e.indicatorType === p.A.PastMistake)) - 1
					},
					[i.w.FirstCorrectCheckpointTest]: {
						...
						test: ({
							player: e
						}) => 0 === e.currentIndex && 1 === e.coachDuo.currentCorrectStreak
					},
					[i.w.FirstWrongCheckpointTest]: {
						...
						test: ({
							player: e
						}) => 0 === e.currentIndex && 1 === e.coachDuo.currentIncorrectStreak
					},
					...
					[i.w.MediumRightStreakCheckpointTest]: {
						...
						test: ({
							player: e
						}) => 4 === e.coachDuo.currentCorrectStreak
					},
					...
					[i.w.SmallRightStreak]: {
						...
						test: ({
							player: e
						}) => 5 === e.coachDuo.currentCorrectStreak
					},
					[i.w.WrongStreak]: {
						...
						test: ({
							player: e
						}) => 3 === e.coachDuo.currentIncorrectStreak
					}
				},
				...
				F = (e, t) => {
					...
					const n = "function" == typeof e.animation ? e.animation(t) : e.animation,
						...
						s = "function" == typeof e.message ? e.message(t) : (0, l.H8)(e.message),
						i = void 0 === e.secondary ? void 0 : "function" == typeof e.secondary ? e.secondary() : (0, l.H8)(e.secondary),
						o = e.trackingIndex;
				...
				I = e => {
					if ((0, s.gQ)("debugCoach")) return (e => {
						console.log("These are all possible coach messages:"), n.XP(R).forEach((t => {
							console.log("====", t), R[t].rawTemplates.forEach((t => {
								var a, n, r;
								const s = F(t, e);
					...
					if (!(0, m.ZX)(e.player.session.type) || !(0, c.h0)().get(u.Lm)) return;
					const t = D(e);
					return void 0 !== t ? {
						showReason: t,
						template: F(P(t, e), e)
				...
				D = e => {
					const {
						player: t,
						user: a
					} = e, n = n => (e => !t.coachDuo.allShowReasons.includes(e))(n) && R[n].test(e) && ([i.w.CapstoneHardExercises, i.w.MistakesReview].includes(n) || (e => {
						var t, n;
		...
		6962: (e, t, a) => {
			...
			var n = a(51827),
				...
				w = a(20028),
				x = a(97106);
			const R = (0, c.p)(["friendsQuestGift", "friendsQuestReward"]),
				T = ["immersivePlus", "plusPromoInterstitial", "plusPromoCarousel", "finalLevelPromotion", "practiceHubPromo"],
				N = (e, t) => {
					if ((0, s.gQ)("debugSlides")) return e;
					const a = e.find((e => "finalLevelFailed" === e.type));
					if (a) return [a];
					e.some((e => "finalLevelPartialXp" === e.type)) && (e = e.filter((e => "sessionComplete" !== e.type))), t.sessionParams.isFinalLevel && !t.session.failed && (e = e.filter((e => "achievementUnlocked" === e.type || "chestLingotsReward" === e.type || "dailyQuestComplete" === e.type || "dailyQuestFirst" === e.type || "dailyQuestHalfway" === e.type || "dailyQuestReward" === e.type || "finalLevelLesson" === e.type || "finalLevelPartialXp" === e.type || "friendStreakUpdate" === e.type || "monthlyChallengeComplete" === e.type || "monthlyGoal" === e.type || "nativeAd" === e.type || "sessionComplete" === e.type || "streakExtended" === e.type))), e.find((e => "checkpointComplete" === e.type && "unitTestFailed" === e.view || "checkpointComplete" === e.type && "sectionTestFailed" === e.view)) && (e = e.filter((e => "chestLingotsReward" !== e.type && "earlyStreakMilestonePrompt" !== e.type && "sessionComplete" !== e.type && "streakExtended" !== e.type && "streakFreezeChestReward" !== e.type))), e.some((e => "streakFreezeChestReward" === e.type)) && (e = e.filter((e => "chestLingotsReward" !== e.type)));
					const n = T.find((t => e.some((e => e.type === t))));
					return e = e.filter((e => e.type === n || !T.includes(e.type))), n && (e = e.filter((e => "nativeAd" !== e.type))), e.some((e => "streakSocietyFreezes" === e.type)) && (e = e.filter((e => "milestoneStreakFreeze" !== e.type))), e
				},
				...
				I = ({
					...
					for (const [r, s] of e.entries())
						if (s.type !== (null === (n = a[t + r + 1]) || void 0 === n ? void 0 : n.type)) return (0, u.Kp)("Expected attached slides to follow main slide, but found a mismatch", {
							data: {
								expected: s,
								found: a[r + t + 1]
							}
				...
				D = ({
					...
					items: N,
					leaderboards: F,
					leaderboardPositionState: I,
					levelData: D,
					monthlyChallengeThreshold: P,
					path: L,
					player: A,
					sectionType: O,
					streakGoalData: M,
					streakGoalOptions: Z,
					streakNudgeState: z,
					streakSocietyProgressState: U,
					subject: G,
					unlockedAchievementsV3: B,
					user: H,
					rewardedHearts: W,
					scoreSessionEndVariant: X,
					showScoreLinkedinSyncOnSessionEnd: V
				}) => {
					...
					const {
						...
						timezoneOffset: Se,
						xpGains: be
					} = H, Ce = null !== (Y = null === (Q = ye.currentStreak) || void 0 === Q ? void 0 : Q.length) && void 0 !== Y ? Y : 0, we = [], [xe, Re] = (() => {
						const e = (0, s.ky)("debugSlides");
					...
					const Ne = (0, x.R7)(Se, be),
						Fe = Ne[6],
						Ie = Ee > 0 && Ee === Fe,
						De = (0, x.Ig)(A, Fe, R),
						Pe = ke === b.FF.SectionTest || ke === b.FF.ChessSectionTest,
						Le = ke === b.FF.UnitTest || ke === b.FF.ChessUnitTest,
						Ae = ke === b.FF.UnitReview && O !== C.t.DAILY_REFRESH,
						Oe = L[L.length - 1],
						Me = L[L.length - 2],
						Ze = (Oe.levels.some((e => void 0 !== e.dailyRefreshInfo)) ? Me.levels[Me.levels.length - 1].id : Oe.levels[Oe.levels.length - 1].id) === (null == D ? void 0 : D.level.id) && ke === b.FF.UnitReview;
					(Te || Ze && "experiment" === (0, i.j6)("path_web_course_complete_slides", void 0)) && (we.push({
						type: "courseCompletionTrophy"
					}), we.push({
						type: "dailyRefreshOnboarding"
					})), (Te || ke === b.FF.Placement || "path-level" === (null === (q = A.sessionRouteParams) || void 0 === q ? void 0 : q.type) && (null === (K = A.sessionRouteParams) || void 0 === K ? void 0 : K.isOnboardingLesson)) && we.push({
						sectionNumber: (null !== (j = null == fe ? void 0 : fe.sectionIndex) && void 0 !== j ? j : -1) + 2,
						type: "placementConfirmation"
					}), we.push({
						type: "sessionComplete",
						xpGoalSessionProgress: De
					}), (0, v.aZ)(X) && void 0 !== X && !V && we.push({
					...
					if (we.push(...Ge), Pe || Te)
						if (Te) we.push({
							...
							if (void 0 === _e) throw Error("sectionIndex undefined after section test complete.");
							he.failed && we.push({
								sectionNumber: _e + 2,
						...
						if (Te) we.push({
							...
							if (void 0 === (null == D ? void 0 : D.unitNumber)) throw Error("unitNumber undefined after unit test complete.");
							we.push({
								type: "checkpointComplete",
							...
							if (void 0 === (null == D ? void 0 : D.unitIndex) && !Te) throw Error("unitIndex undefined after unit review complete.");
							we.push({
								type: "checkpointComplete",
					...
					if (Te ? (we.push({
						...
						type: "streakFreezeGift"
					})), [b.FF.LegendaryLevel, b.FF.LegendaryLexemePractice].includes(ke) && "legendary" === (null == D ? void 0 : D.level.state) || Te) {
						let e = null == D ? void 0 : D.unitIndex,
							t = null == D ? void 0 : D.unitNumber;
						if (void 0 === e || void 0 === t) {
							if (!Te) throw Error("Missing unit index for legendary earned slide.");
							e = 0, t = 0
						}
						we.push({
					...
					if (A.sessionParams.isFinalLevel && !A.completedWithHeartsRemaining && we.push({
						...
						type: "createProfile"
					}), T && null !== (0, n.Z7)(H, n.ZD.SessionEnd) && we.push({
						type: "nativeAd"
					}), (Te || he.type === b.FF.MistakesReview && 0 === (null === (ne = H.mistakeCountInfo) || void 0 === ne ? void 0 : ne.mistakeCount)) && we.push({
					...
					} else F.classroomLeaderboard && (0, g.S2)(H.id, F.classroomLeaderboard.state, null !== (re = he.xpPromised) && void 0 !== re ? re : Ee) && we.push({
						classroomLeaderboard: F.classroomLeaderboard,
						totalSessionXpGain: null !== (se = he.xpPromised) && void 0 !== se ? se : Ee,
						type: "schoolsClassroomLeaderboardMoveUp"
					});
					...
					if (Te) we.push({
						...
						const e = (0, d.c$)(Be, I, F.sessionEndData);
						e && we.push(e)
					}
					if (Te) {
						...
						if (u.pendingRewards.length)
							if (1 === e.length)
								if ((0, p.Se)(u.pendingRewards[0].reward)) {
					...
					if (Te ? (we.push({
						...
						oldProgress: He,
						type: "monthlyChallengeComplete"
					}) : We !== He && He < P && (Xe = He, Ve = We, Math.floor(Ve / 5) > Math.floor(Xe / 5)) && we.push({
						newProgress: We,
						oldProgress: He,
						type: "monthlyGoal"
					}), (Te || W > 0) && we.push({
					...
					else if (ke === b.FF.LevelReview || ke === b.FF.LexemePractice && "practice_level_review" === fe.lexemePracticeType) {
						const e = null === (ce = (0, p.f7)(H)) || void 0 === ce ? void 0 : ce.rewards[0],
							t = u.pendingRewards.some((({
								reward: e
							}) => (0, p.be)(e))),
							a = R || t;
						we.push({
					...
					if (Te) {
						...
						void 0 === (0, S.vz)(Ce) || void 0 === e || void 0 === t ? we.push({
						...
						if (void 0 !== N.inventory.society_streak_freeze_refill && (void 0 === N.inventory.society_streak_freeze || 0 === (null === (ue = N.inventory.society_streak_freeze) || void 0 === ue ? void 0 : ue.quantity))) {
							const e = (Math.floor(Ce / S.mx) + 1) * S.mx;
							we.push({
								nextMilestone: e,
								type: "streakSocietyFreezes"
							})
						...
						if (0 !== Ce && void 0 !== e && void 0 !== t && (0, E.dN)(Ce, t, null == U ? void 0 : U.lastShownStartDate, null == U ? void 0 : U.lastStreak) && we.push({
							currentStreakStartDate: t,
							nextRewardMilestone: e,
							streak: Ce,
							type: "streakSocietyProgress"
							...
							type: "streakSocietyWelcomeChest"
						}), Ie && Ce >= S.ME && Ce % S.ME == 0) {
							const e = Math.floor(Ce / S.ME);
							e >= 2 ? we.push({
								type: "streakSocietyVipUpdate",
								years: e
							}) : we.push({
					...
					if (Te)
					...
					else if (void 0 !== Ye && (0, o.BQ)(H)) {
						const {
							metric: e,
							totalProgress: t,
							threshold: a
						} = Ye, n = u.friendsQuest.lastSeenTotalProgress;
						if (t >= a && (null != n ? n : 0) < a && !Ye.acknowledged) we.push({
							attachedSlides: [{
								type: "friendsQuestReward"
							}],
						...
						else if ((0, o.JD)(Date.now()) && t < a && t >= a / 2 && (null != n ? n : 0) < a / 2) {
					...
					if (void 0 !== Re) {
						const e = Re.slice(),
							t = we.filter((t => {
								if (!Re.includes(t.type)) return !1;
								const a = e.indexOf(t.type);
								return a > -1 && e.splice(a, 1), !0
							}));
						return e.length && console.warn(`1 or more invalid debugSlides: "${e.join(",")}"`), t
					}
					return we
				}
		},
		...
		54042: (e, t, a) => {
			...
			var n = a(27378),
				r = a(50498);
			const s = ({
				canStartAnimation: e = !0,
				getAnimationStepProperties: t,
				initialAnimationState: a
			}) => {
				...
				return n.useEffect((() => {
					...
					return (async () => {
						const e = t(s);
						e && (await (0, r._v)(e.duration), a.signal.aborted || i(e.nextState))
					})(), () => {
						a.abort()
					}
				}), [s, e]), s
					...
					try {
						...
						return Array.isArray(n) ? n.map(((e, t) => {
							...
							const {
								response: i,
								secondary: o
							} = e, l = null != i ? i : {}, c = n[t + 1], {
								copy: d
							} = null !== (a = null == c ? void 0 : c.action) && void 0 !== a ? a : {}, u = Array.isArray(o) ? o.map((e => {
								var t;
								const {
									chip: a,
									response: n
		...
		7432: (e, t, a) => {
			...
			const c = (e, t, a) => {
				...
				g = (e, t) => (t && (0, s.Wc)(t.level.state) ? l.ix : l.aS) * p(e),
				v = (e, t, a) => {
					var r;
					const s = {
						skillId: e.skillId,
					...
					switch (e.type) {
						case o.FF.AlphabetLesson:
							return {
								...s, eventType: n.Vi.EventType.LESSON, xp: (l.ct + d(e) + m(e)) * p(e)
							};
						case o.FF.AlphabetPractice:
							return {
								...s, eventType: n.Vi.EventType.LESSON, xp: (l.t1 + d(e) + m(e)) * p(e)
							};
						...
						case o.FF.LevelReview: {
							if (void 0 === t) throw Error("Level data needs to be provided");
		...
		53146: (e, t, a) => {
			...
			const l = ["sessionComplete", "scoreProgressTouchPoint", "scoreLinkedinSync", "finalLevelPartialXp", "dailyQuestComplete", "dailyQuestReward", "streakExtended", "checkpointComplete", "finalLevelLesson", "mistakesInboxEmpty", "finalLevelFailed"],
				c = async (e, {
							...
							case "checkpointComplete":
								switch (e.slide.view) {
									...
									case "unitTestPassed":
										return "unit_test";
									default:
										return void (0, i.RJ)(e.slide.view)
								}
							case "heartRefill":
					...
					(0, o.track)("session_end_screen_shown", {
						...e.tracking,
					...
					}), "cta" === e.action ? (0, o.track)("session_end_message_cta_clicked", {
						message_name: e.slide.type,
						session_end_screen_name: a
					}) : "dismiss" === e.action && (0, o.track)("session_end_message_dismiss_clicked", {
						message_name: e.slide.type,
						session_end_screen_name: a
					})
				}
		...
		55318: (e, t, a) => {
			...
			const s = ({
				...
				friendStreakData: t,
				friendStreakCombinedData: a,
				streakJustExtended: s,
				user: i
			}) => {
				var o, l, c;
				const d = [],
					u = (0, n.m7)(i) && void 0 !== (null === (o = null == t ? void 0 : t.matchInfo) || void 0 === o ? void 0 : o.emptySlots) && (null === (l = null == t ? void 0 : t.matchInfo) || void 0 === l ? void 0 : l.emptySlots) > 0 && void 0 !== (null == t ? void 0 : t.potentialMatches) && (null === (c = null == t ? void 0 : t.potentialMatches) || void 0 === c ? void 0 : c.length) > 0 ? {
				...
				void 0 !== u && d.push(u);
				const m = (() => {
					if ((0, n.m7)(i) && s && (0, r.iJ)(a) && 0 !== a.length) return {
						friendStreakInfo: (0, r.XN)(a, s).map((e => ({
							friend: {
				...
				return void 0 !== m && d.push(m), e && (d.some((e => "friendStreakInviteOffer" === e.type)) || d.push(null != u ? u : {
		...
		32401: (e, t, a) => {
			...
			const r = ({
				debugSlides: e,
				isEarnbackSessionComplete: t,
				streak: a,
				streakGoalData: r,
				streakGoalOptions: s,
				streakJustExtended: i,
				user: o
			}) => {
				if (e) return [{
					nextButtonEnabled: !1,
				...
				if (void 0 !== l) {
					if (a === l.nextSelectedGoal.length) return [{
						currentStreak: a,
						gemReward: (0, n.AB)(l.nextSelectedGoal),
						nextButtonEnabled: !1,
						nextOptions: s.currentStreakOptions,
						rewardId: (0, n.z_)(o, l.nextSelectedGoal),
						subtype: "streakGoalComplete",
						type: "earlyStreakMilestonePrompt"
					}];
		...
		20579: (e, t, a) => {
			...
			const o = ({
				currentDate: e,
				debugSlides: t,
				isEarnbackSessionComplete: a,
				overrideWeekStartDayForTesting: o,
				streak: l,
				streakJustExtended: c,
				streakNudgeState: d,
				subject: u,
				user: m,
				xpGain: p,
				...
				return (t || (0, n.NE)(c, l, null == d ? void 0 : d.count, null == d ? void 0 : d.resurrectionTimestamp, m.lastResurrectionTimestamp) && !a) && h.push({
					daysInCurrentStreak: S,
					isPerfectStreakWeekLost: k,
					perfectWeekDay: _,
					template: (0, n.eU)(l),
